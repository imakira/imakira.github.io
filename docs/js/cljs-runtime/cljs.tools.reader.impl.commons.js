...
var G__79934 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__79934;
continue;
} else {
return ch;
...
var vec__79901 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79901,(0),null);
return (match === s);
});
...
var len__5875__auto___79944 = arguments.length;
var i__5876__auto___79946 = (0);
while(true){
if((i__5876__auto___79946 < len__5875__auto___79944)){
args__5881__auto__.push((arguments[i__5876__auto___79946]));

var G__79947 = (i__5876__auto___79946 + (1));
i__5876__auto___79946 = G__79947;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq79918){
var G__79919 = cljs.core.first(seq79918);
var seq79918__$1 = cljs.core.next(seq79918);
var self__5860__auto__ = this;
return self__5860__auto__.cljs$core$IFn$_invoke$arity$variadic(G__79919,seq79918__$1);
}));

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__79954__delegate = function (rdr,_){
...
var G__79954 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__79958__i = 0, G__79958__a = new Array(arguments.length -  1);
while (G__79958__i < G__79958__a.length) {G__79958__a[G__79958__i] = arguments[G__79958__i + 1]; ++G__79958__i;}
  _ = new cljs.core.IndexedSeq(G__79958__a,0,null);
} 
return G__79954__delegate.call(this,rdr,_);};
G__79954.cljs$lang$maxFixedArity = 1;
G__79954.cljs$lang$applyTo = (function (arglist__79959){
var rdr = cljs.core.first(arglist__79959);
var _ = cljs.core.rest(arglist__79959);
return G__79954__delegate(rdr,_);
});
G__79954.cljs$core$IFn$_invoke$arity$variadic = G__79954__delegate;
return G__79954;
})()
;
});
