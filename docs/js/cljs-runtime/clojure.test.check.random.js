...
var clojure$test$check$random$IRandom$rand_long$dyn_102214 = (function (rng){
...
return clojure$test$check$random$IRandom$rand_long$dyn_102214(rng);
}
});

var clojure$test$check$random$IRandom$rand_double$dyn_102215 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$rand_double$dyn_102215(rng);
}
});

var clojure$test$check$random$IRandom$split$dyn_102218 = (function (rng){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split$dyn_102218(rng);
}
});

var clojure$test$check$random$IRandom$split_n$dyn_102222 = (function (rng,n){
var x__5373__auto__ = (((rng == null))?null:rng);
...
return clojure$test$check$random$IRandom$split_n$dyn_102222(rng,n);
}
});
...
var G__102124 = z;
if(((24) > (function (){var G__102136 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__102136) : clojure.test.check.random.longs.bit_count.call(null,G__102136));
})())){
return clojure.test.check.random.longs.bit_xor(G__102124,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__102124;
}
});
...
var G__102235 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__102236 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__102235;
ret = G__102236;
continue;
}
...
return (function (){
return new cljs.core.Keyword(null,"returned","returned",-2020439163).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(a,(function (p__102190){
var map__102191 = p__102190;
var map__102191__$1 = cljs.core.__destructure_map(map__102191);
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__102191__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__102192 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102192,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__102192,(1),null);
...
var G__102210 = arguments.length;
switch (G__102210) {
case 0:
