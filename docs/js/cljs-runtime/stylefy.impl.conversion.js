...
var temp__5823__auto__ = new cljs.core.Keyword("stylefy.core","vendors","stylefy.core/vendors",362354809).cljs$core$IFn$_invoke$arity$1(props);
if(cljs.core.truth_(temp__5823__auto__)){
var vendors = temp__5823__auto__;
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__106445_SHARP_){
return handle_mode(p1__106445_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__106445_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__106446_SHARP_){
return handle_mode(cljs.core.first(p1__106446_SHARP_),cljs.core.second(p1__106446_SHARP_));
}),modes);
} else {
return null;
}
 ...
 */
stylefy.impl.conversion.convert_base_style_into_class = (function stylefy$impl$conversion$convert_base_style_into_class(p__106454,options){
var map__106455 = p__106454;
var map__106455__$1 = cljs.core.__destructure_map(map__106455);
var _style = map__106455__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106455__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106455__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106455__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
var css_props = stylefy.impl.utils.remove_special_keywords(props);
var css_selector = (function (){var or__5025__auto__ = custom_selector;
...
var garden_options = (function (){var or__5025__auto__ = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([options,garden_vendors], 0));
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
return clojure.walk.walk((function (p1__106458_SHARP_){
if(cljs.core.map_QMARK_(p1__106458_SHARP_)){
return stylefy.impl.utils.remove_special_keywords(p1__106458_SHARP_);
} else {
return p1__106458_SHARP_;
}
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__106463_SHARP_){
return (stylefy.impl.conversion.find_and_handle_scoped_style_map.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.conversion.find_and_handle_scoped_style_map.cljs$core$IFn$_invoke$arity$2(p1__106463_SHARP_,scope) : stylefy.impl.conversion.find_and_handle_scoped_style_map.call(null,p1__106463_SHARP_,scope));
}),item);
} else {
return item;
 ...
 */
stylefy.impl.conversion.convert_scoped_styles = (function stylefy$impl$conversion$convert_scoped_styles(p__106466,options){
var map__106467 = p__106466;
var map__106467__$1 = cljs.core.__destructure_map(map__106467);
var _style = map__106467__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106467__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106467__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106467__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
var temp__5823__auto__ = new cljs.core.Keyword("stylefy.core","scope","stylefy.core/scope",889108251).cljs$core$IFn$_invoke$arity$1(props);
if(cljs.core.truth_(temp__5823__auto__)){
var stylefy_scoped_styles = temp__5823__auto__;
var css_parent_selector = (function (){var or__5025__auto__ = custom_selector;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
return stylefy.impl.conversion.class_selector(hash);
 ...
 *   media queries.
 */
stylefy.impl.conversion.convert_media_queries = (function stylefy$impl$conversion$convert_media_queries(p__106480,options){
var map__106481 = p__106480;
var map__106481__$1 = cljs.core.__destructure_map(map__106481);
var _style = map__106481__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106481__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106481__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106481__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
var temp__5823__auto__ = new cljs.core.Keyword("stylefy.core","media","stylefy.core/media",-1323617834).cljs$core$IFn$_invoke$arity$1(props);
if(cljs.core.truth_(temp__5823__auto__)){
var media_queries = temp__5823__auto__;
var css_selector = (function (){var or__5025__auto__ = custom_selector;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var css_media_queries = ((cljs.core.map_QMARK_(media_queries))?cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__106478_SHARP_){
return handle_media_query(p1__106478_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(media_queries,p1__106478_SHARP_));
}),cljs.core.keys(media_queries)):((cljs.core.vector_QMARK_(media_queries))?cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__106479_SHARP_){
return handle_media_query(cljs.core.first(p1__106479_SHARP_),cljs.core.second(p1__106479_SHARP_));
}),media_queries):null));
 ...
 */
stylefy.impl.conversion.convert_feature_queries = (function stylefy$impl$conversion$convert_feature_queries(p__106514,options){
var map__106516 = p__106514;
var map__106516__$1 = cljs.core.__destructure_map(map__106516);
var _style = map__106516__$1;
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106516__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106516__$1,new cljs.core.Keyword(null,"props","props",453281727));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106516__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
var temp__5823__auto__ = new cljs.core.Keyword("stylefy.core","supports","stylefy.core/supports",105019324).cljs$core$IFn$_invoke$arity$1(props);
if(cljs.core.truth_(temp__5823__auto__)){
var supports_rules = temp__5823__auto__;
var handle_supports_rule = (function (supports_query,supports_props){
return ["@supports (",cljs.core.str.cljs$core$IFn$_invoke$arity$1(supports_query),") {",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__106531 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"props","props",453281727),supports_props,new cljs.core.Keyword(null,"hash","hash",-13781596),hash,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277),custom_selector], null);
var G__106532 = options;
return (stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$2(G__106531,G__106532) : stylefy.impl.conversion.style__GT_css.call(null,G__106531,G__106532));
})()),"}"].join('');
});
var css_supports = ((cljs.core.map_QMARK_(supports_rules))?cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__106507_SHARP_){
return handle_supports_rule(p1__106507_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(supports_rules,p1__106507_SHARP_));
}),cljs.core.keys(supports_rules)):((cljs.core.vector_QMARK_(supports_rules))?cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__106508_SHARP_){
return handle_supports_rule(cljs.core.first(p1__106508_SHARP_),cljs.core.second(p1__106508_SHARP_));
}),supports_rules):null));
 ...
 */
stylefy.impl.conversion.convert_manual_styles = (function stylefy$impl$conversion$convert_manual_styles(p__106557,options){
var map__106559 = p__106557;
var map__106559__$1 = cljs.core.__destructure_map(map__106559);
var _style = map__106559__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106559__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106559__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106559__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
var temp__5823__auto__ = new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369).cljs$core$IFn$_invoke$arity$1(props);
if(cljs.core.truth_(temp__5823__auto__)){
var stylefy_manual_styles = temp__5823__auto__;
var css_parent_selector = (function (){var or__5025__auto__ = custom_selector;
if(cljs.core.truth_(or__5025__auto__)){
return or__5025__auto__;
} else {
...
var G__106586 = arguments.length;
switch (G__106586) {
case 1:
