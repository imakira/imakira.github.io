...
if(cljs.core.truth_((function (){var and__5023__auto__ = cache_created;
...
var temp__5823__auto__ = window.localStorage.getItem(key);
if(cljs.core.truth_(temp__5823__auto__)){
var cache_contents = temp__5823__auto__;
...
var G__106028 = arguments.length;
switch (G__106028) {
case 1:
...
var G__106036 = arguments.length;
switch (G__106036) {
case 0:
...
var G__106044 = arguments.length;
switch (G__106044) {
case 1:
...
if(stylefy.impl.cache.cache_expired_QMARK_(stylefy.impl.cache.read_cache_value(stylefy.impl.cache.cache_key_created(instance_id)),(function (){var or__5025__auto__ = new cljs.core.Keyword(null,"expires","expires",1393008816).cljs$core$IFn$_invoke$arity$1(cache_options);
...
if(cljs.core.truth_((function (){var and__5023__auto__ = cljs.core.deref(stylefy.impl.cache.cache_styles_QMARK_);
if(cljs.core.truth_(and__5023__auto__)){
...
return cljs.core.boolean$(cljs.core.some((function (p1__106049_SHARP_){
return cljs.core.contains_QMARK_(p1__106049_SHARP_,new cljs.core.Keyword("stylefy.impl.dom","css","stylefy.impl.dom/css",915861061));
}),cached_maps));
});
/**
