...
var v__44038__auto___71238 = children;
if(cljs.core.seq(v__44038__auto___71238)){
var x__44039__auto___71239 = cljs.core.first(v__44038__auto___71238);
var xs__44040__auto___71240 = cljs.core.next(v__44038__auto___71238);
while(true){
var child_71241 = x__44039__auto___71239;
if(cljs.core.truth_(uix.compiler.aot.hiccup_QMARK_(child_71241))){
throw (new Error((""+"Hiccup is not valid as UIx child (found: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(child_71241)+").\n"+"If you meant to render UIx element, use `$` macro, i.e. ($ "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",child_71241))+")\n"+"If you meant to render Reagent element, wrap it with r/as-element, i.e. (r/as-element "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(child_71241)+")")));
} else {
if(cljs.core.sequential_QMARK_(child_71241)){
(uix.compiler.aot.validate_children.cljs$core$IFn$_invoke$arity$1 ? uix.compiler.aot.validate_children.cljs$core$IFn$_invoke$arity$1(child_71241) : uix.compiler.aot.validate_children.call(null,child_71241));
} else {
}
}

if(cljs.core.seq(xs__44040__auto___71240)){
var G__71245 = cljs.core.first(xs__44040__auto___71240);
var G__71246 = cljs.core.next(xs__44040__auto___71240);
x__44039__auto___71239 = G__71245;
xs__44040__auto___71240 = G__71246;
continue;
} else {
}
break;
