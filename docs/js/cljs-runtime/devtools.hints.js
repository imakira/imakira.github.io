...
var map__70699 = top_item;
var map__70699__$1 = cljs.core.__destructure_map(map__70699);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70699__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70699__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70699__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e70698){var _e = e70698;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5823__auto___70724 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5823__auto___70724)){
var seen_errors_70725 = temp__5823__auto___70724;
if(cljs.core.truth_(seen_errors_70725.has(self))){
} else {
seen_errors_70725.add(self);

var temp__5825__auto___70726 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5825__auto___70726)){
var sense_70727 = temp__5825__auto___70726;
(self.message = (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message)+", a sanity hint:\n"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_70727)));
} else {
}
}
} else {
