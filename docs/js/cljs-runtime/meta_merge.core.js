...
return cljs.core.boolean$((function (){var or__5141__auto__ = cljs.core.some(cljs.core.some_fn.cljs$core$IFn$_invoke$arity$3(cljs.core.nil_QMARK_,meta_merge.core.displace_QMARK_,meta_merge.core.replace_QMARK_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [left,right], null));
...
if(cljs.core.truth_((function (){var and__5139__auto__ = meta_merge.core.displace_QMARK_(left);
...
if(cljs.core.truth_((function (){var and__5139__auto__ = meta_merge.core.replace_QMARK_(left);
if(cljs.core.truth_(and__5139__auto__)){
...
if(cljs.core.truth_((function (){var or__5141__auto__ = meta_merge.core.displace_QMARK_(left);
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
return meta_merge.core.replace_QMARK_(right);
...
if(cljs.core.truth_((function (){var or__5141__auto__ = meta_merge.core.replace_QMARK_(left);
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
return meta_merge.core.displace_QMARK_(right);
...
var len__5875__auto___75762 = arguments.length;
var i__5876__auto___75763 = (0);
while(true){
if((i__5876__auto___75763 < len__5875__auto___75762)){
args_arr__5900__auto__.push((arguments[i__5876__auto___75763]));

var G__75764 = (i__5876__auto___75763 + (1));
i__5876__auto___75763 = G__75764;
continue;
} else {
}
break;
...
return meta_merge.core.meta_merge.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5901__auto__);
...
if(cljs.core.truth_((function (){var or__5141__auto__ = new cljs.core.Keyword(null,"prepend","prepend",342616040).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(left));
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
...
/** @this {Function} */
(meta_merge.core.meta_merge.cljs$lang$applyTo = (function (seq75726){
var G__75727 = cljs.core.first(seq75726);
var seq75726__$1 = cljs.core.next(seq75726);
var G__75728 = cljs.core.first(seq75726__$1);
var seq75726__$2 = cljs.core.next(seq75726__$1);
var self__5860__auto__ = this;
return self__5860__auto__.cljs$core$IFn$_invoke$arity$variadic(G__75727,G__75728,seq75726__$2);
}));
