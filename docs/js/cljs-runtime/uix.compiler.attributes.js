...
return (function() { 
var G__75148__delegate = function (rest__75031_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,rest__75031_SHARP_);
};
var G__75148 = function (var_args){
var rest__75031_SHARP_ = null;
if (arguments.length > 0) {
var G__75149__i = 0, G__75149__a = new Array(arguments.length -  0);
while (G__75149__i < G__75149__a.length) {G__75149__a[G__75149__i] = arguments[G__75149__i + 0]; ++G__75149__i;}
  rest__75031_SHARP_ = new cljs.core.IndexedSeq(G__75149__a,0,null);
} 
return G__75148__delegate.call(this,rest__75031_SHARP_);};
G__75148.cljs$lang$maxFixedArity = 0;
G__75148.cljs$lang$applyTo = (function (arglist__75150){
var rest__75031_SHARP_ = cljs.core.seq(arglist__75150);
return G__75148__delegate(rest__75031_SHARP_);
});
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__75156__delegate = function (rest__75036_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,rest__75036_SHARP_);
};
var G__75156 = function (var_args){
var rest__75036_SHARP_ = null;
if (arguments.length > 0) {
...
while (G__75157__i < G__75157__a.length) {G__75157__a[G__75157__i] = arguments[G__75157__i + 0]; ++G__75157__i;}
  rest__75036_SHARP_ = new cljs.core.IndexedSeq(G__75157__a,0,null);
} 
return G__75156__delegate.call(this,rest__75036_SHARP_);};
G__75156.cljs$lang$maxFixedArity = 0;
G__75156.cljs$lang$applyTo = (function (arglist__75158){
var rest__75036_SHARP_ = cljs.core.seq(arglist__75158);
return G__75156__delegate(rest__75036_SHARP_);
});
...
var len__5875__auto___75174 = arguments.length;
var i__5876__auto___75175 = (0);
while(true){
if((i__5876__auto___75175 < len__5875__auto___75174)){
args_arr__5900__auto__.push((arguments[i__5876__auto___75175]));

var G__75176 = (i__5876__auto___75175 + (1));
i__5876__auto___75175 = G__75176;
continue;
} else {
}
break;
...
return uix.compiler.attributes.class_names.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5901__auto__);

}
});

(uix.compiler.attributes.class_names.cljs$core$IFn$_invoke$arity$1 = (function (a){
if(cljs.core.truth_((function (){var or__5141__auto__ = cljs.core.array_QMARK_(a);
...
/** @this {Function} */
(uix.compiler.attributes.class_names.cljs$lang$applyTo = (function (seq75050){
...
return self__5860__auto__.cljs$core$IFn$_invoke$arity$variadic(G__75051,G__75052,seq75050__$2);
}));
...
if(cljs.core.truth_((function (){var and__5139__auto__ = cljs.core.not(cljs.core.re_matches(uix.compiler.attributes.re_tag,tag_str));
...
var vec__75069 = cljs.core.next(cljs.core.re_matches(uix.compiler.attributes.re_tag,tag_str));
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75069,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75069,(1),null);
var class_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75069,(2),null);
...
var class_QMARK_ = (function (){var or__5141__auto__ = class$;
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
var or__5141__auto____$1 = props_class;
if(cljs.core.truth_(or__5141__auto____$1)){
return or__5141__auto____$1;
} else {
var or__5141__auto____$2 = props_class_name;
...
var G__75089 = props;
var G__75089__$1 = (((((!((id == null)))) && ((cljs.core.get.cljs$core$IFn$_invoke$arity$2(props,new cljs.core.Keyword(null,"id","id",-1388402092)) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__75089,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__75089);
if(cljs.core.truth_(class_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__75089__$1,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"class-name","class-name",945142584),new cljs.core.Keyword(null,"className","className",-1983287057)], 0)),new cljs.core.Keyword(null,"class","class",-2030961996),uix.compiler.attributes.class_names.cljs$core$IFn$_invoke$arity$variadic(class$,props_class,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([props_class_name,props_className], 0)));
} else {
return G__75089__$1;
}
});
