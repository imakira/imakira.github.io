...
return (function() { 
var G__70971__delegate = function (rest__70885_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,rest__70885_SHARP_);
};
var G__70971 = function (var_args){
var rest__70885_SHARP_ = null;
if (arguments.length > 0) {
var G__70973__i = 0, G__70973__a = new Array(arguments.length -  0);
while (G__70973__i < G__70973__a.length) {G__70973__a[G__70973__i] = arguments[G__70973__i + 0]; ++G__70973__i;}
  rest__70885_SHARP_ = new cljs.core.IndexedSeq(G__70973__a,0,null);
} 
return G__70971__delegate.call(this,rest__70885_SHARP_);};
G__70971.cljs$lang$maxFixedArity = 0;
G__70971.cljs$lang$applyTo = (function (arglist__70975){
var rest__70885_SHARP_ = cljs.core.seq(arglist__70975);
return G__70971__delegate(rest__70885_SHARP_);
});
G__70971.cljs$core$IFn$_invoke$arity$variadic = G__70971__delegate;
return G__70971;
})()
;
} else {
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__70977__delegate = function (rest__70886_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,rest__70886_SHARP_);
};
var G__70977 = function (var_args){
var rest__70886_SHARP_ = null;
if (arguments.length > 0) {
var G__70978__i = 0, G__70978__a = new Array(arguments.length -  0);
while (G__70978__i < G__70978__a.length) {G__70978__a[G__70978__i] = arguments[G__70978__i + 0]; ++G__70978__i;}
  rest__70886_SHARP_ = new cljs.core.IndexedSeq(G__70978__a,0,null);
} 
return G__70977__delegate.call(this,rest__70886_SHARP_);};
G__70977.cljs$lang$maxFixedArity = 0;
G__70977.cljs$lang$applyTo = (function (arglist__70979){
var rest__70886_SHARP_ = cljs.core.seq(arglist__70979);
return G__70977__delegate(rest__70886_SHARP_);
});
G__70977.cljs$core$IFn$_invoke$arity$variadic = G__70977__delegate;
return G__70977;
})()
;
} else {
...
var len__5876__auto___70984 = arguments.length;
var i__5877__auto___70985 = (0);
while(true){
if((i__5877__auto___70985 < len__5876__auto___70984)){
args_arr__5901__auto__.push((arguments[i__5877__auto___70985]));

var G__70988 = (i__5877__auto___70985 + (1));
i__5877__auto___70985 = G__70988;
continue;
} else {
}
break;
...
if(cljs.core.truth_((function (){var or__5142__auto__ = cljs.core.array_QMARK_(a);
...
/** @this {Function} */
(uix.compiler.attributes.class_names.cljs$lang$applyTo = (function (seq70897){
...
return self__5861__auto__.cljs$core$IFn$_invoke$arity$variadic(G__70898,G__70899,seq70897__$2);
}));
...
if(cljs.core.truth_((function (){var and__5140__auto__ = cljs.core.not(cljs.core.re_matches(uix.compiler.attributes.re_tag,tag_str));
...
var vec__70913 = cljs.core.next(cljs.core.re_matches(uix.compiler.attributes.re_tag,tag_str));
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70913,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70913,(1),null);
var class_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70913,(2),null);
...
var G__70926 = props;
var G__70926__$1 = (((((!((id == null)))) && ((cljs.core.get.cljs$core$IFn$_invoke$arity$2(props,new cljs.core.Keyword(null,"id","id",-1388402092)) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__70926,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__70926);
if(cljs.core.truth_(class_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__70926__$1,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"class-name","class-name",945142584),new cljs.core.Keyword(null,"className","className",-1983287057)], 0)),new cljs.core.Keyword(null,"class","class",-2030961996),uix.compiler.attributes.class_names.cljs$core$IFn$_invoke$arity$variadic(class$,props_class,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([props_class_name,props_className], 0)));
} else {
return G__70926__$1;
}
});
