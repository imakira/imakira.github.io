...
(cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__5433__auto__,writer__5434__auto__,opt__5435__auto__){
return cljs.core._write(writer__5434__auto__,"cljs.core.async.impl.timers/SkipListNode");
}));
...
var i_69774 = (0);
while(true){
if((i_69774 < arr.length)){
(arr[i_69774] = null);

var G__69775 = (i_69774 + (1));
i_69774 = G__69775;
continue;
} else {
}
...
var i_69805 = (self__.level + (1));
while(true){
if((i_69805 <= (new_level + (1)))){
(update[i_69805] = self__.header);

var G__69807 = (i_69805 + (1));
i_69805 = G__69807;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_69814 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_69814[i]));
} else {
x__$2.forward.push((((i < links_69814.length))?(links_69814[i]):null));
}

if((i < links_69814.length)){
(links_69814[i] = x__$2);
} else {
links_69814.push(x__$2);
}
...
var i_69818 = (0);
while(true){
if((i_69818 <= self__.level)){
var links_69819 = (update[i_69818]).forward;
if((x__$1 === (((i_69818 < links_69819.length))?(links_69819[i_69818]):null))){
(links_69819[i_69818] = (x__$1.forward[i_69818]));

var G__69820 = (i_69818 + (1));
i_69818 = G__69820;
continue;
} else {
var G__69822 = (i_69818 + (1));
i_69818 = G__69822;
continue;
}
} else {
...
var G__69824 = nx;
var G__69825 = (level__$1 - (1));
x = G__69824;
level__$1 = G__69825;
continue;
} else {
var G__69826 = x;
var G__69827 = (level__$1 - (1));
x = G__69826;
level__$1 = G__69827;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__69834 = nx;
var G__69835 = (level__$1 - (1));
x = G__69834;
level__$1 = G__69835;
continue;
} else {
var G__69836 = x;
var G__69837 = (level__$1 - (1));
x = G__69836;
level__$1 = G__69837;
continue;
}
...
(cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__5433__auto__,writer__5434__auto__,opt__5435__auto__){
return cljs.core._write(writer__5434__auto__,"cljs.core.async.impl.timers/SkipList");
}));
...
var or__5141__auto__ = (cljs.core.truth_((function (){var and__5139__auto__ = me;
