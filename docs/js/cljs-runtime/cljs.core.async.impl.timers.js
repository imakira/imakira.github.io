...
var i_94283 = (self__.level + (1));
while(true){
if((i_94283 <= (new_level + (1)))){
(update[i_94283] = self__.header);

var G__94284 = (i_94283 + (1));
i_94283 = G__94284;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_94285 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_94285[i]));
} else {
x__$2.forward.push((((i < links_94285.length))?(links_94285[i]):null));
}

if((i < links_94285.length)){
(links_94285[i] = x__$2);
} else {
links_94285.push(x__$2);
}
...
var i_94302 = (0);
while(true){
if((i_94302 <= self__.level)){
var links_94303 = (update[i_94302]).forward;
if((x__$1 === (((i_94302 < links_94303.length))?(links_94303[i_94302]):null))){
(links_94303[i_94302] = (x__$1.forward[i_94302]));

var G__94306 = (i_94302 + (1));
i_94302 = G__94306;
continue;
} else {
var G__94307 = (i_94302 + (1));
i_94302 = G__94307;
continue;
}
} else {
...
var G__94312 = nx;
var G__94313 = (level__$1 - (1));
x = G__94312;
level__$1 = G__94313;
continue;
} else {
var G__94314 = x;
var G__94315 = (level__$1 - (1));
x = G__94314;
level__$1 = G__94315;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__94320 = nx;
var G__94321 = (level__$1 - (1));
x = G__94320;
level__$1 = G__94321;
continue;
} else {
var G__94322 = x;
var G__94323 = (level__$1 - (1));
x = G__94322;
level__$1 = G__94323;
continue;
}
