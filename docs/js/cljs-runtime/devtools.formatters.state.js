...
var len__5875__auto___67896 = arguments.length;
var i__5876__auto___67897 = (0);
while(true){
if((i__5876__auto___67897 < len__5875__auto___67896)){
args__5881__auto__.push((arguments[i__5876__auto___67897]));

var G__67898 = (i__5876__auto___67897 + (1));
i__5876__auto___67897 = G__67898;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5882__auto__);
});
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq67723){
var G__67724 = cljs.core.first(seq67723);
var seq67723__$1 = cljs.core.next(seq67723);
var self__5860__auto__ = this;
return self__5860__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67724,seq67723__$1);
}));
...
return cljs.core.some((function (p1__67746_SHARP_){
return (p1__67746_SHARP_ === object);
}),history__$1);
});
...
var args__5881__auto__ = [];
var len__5875__auto___67911 = arguments.length;
var i__5876__auto___67912 = (0);
while(true){
if((i__5876__auto___67912 < len__5875__auto___67911)){
args__5881__auto__.push((arguments[i__5876__auto___67912]));

var G__67919 = (i__5876__auto___67912 + (1));
i__5876__auto___67912 = G__67919;
continue;
} else {
}
break;
...
var argseq__5882__auto__ = ((((1) < args__5881__auto__.length))?(new cljs.core.IndexedSeq(args__5881__auto__.slice((1)),(0),null)):null);
return devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5882__auto__);
});

(devtools.formatters.state.present_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (v,p__67754){
var vec__67755 = p__67754;
var starting_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67755,(0),null);
if(typeof v === 'string'){
return v;
} else {
...
/** @this {Function} */
(devtools.formatters.state.present_path_segment.cljs$lang$applyTo = (function (seq67749){
var G__67750 = cljs.core.first(seq67749);
var seq67749__$1 = cljs.core.next(seq67749);
var self__5860__auto__ = this;
return self__5860__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67750,seq67749__$1);
}));

devtools.formatters.state.seek_path_segment = (function devtools$formatters$state$seek_path_segment(var_args){
var args__5881__auto__ = [];
var len__5875__auto___67927 = arguments.length;
var i__5876__auto___67929 = (0);
while(true){
if((i__5876__auto___67929 < len__5875__auto___67927)){
args__5881__auto__.push((arguments[i__5876__auto___67929]));

var G__67931 = (i__5876__auto___67929 + (1));
i__5876__auto___67929 = G__67931;
continue;
} else {
}
break;
...
return devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5882__auto__);
});

(devtools.formatters.state.seek_path_segment.cljs$core$IFn$_invoke$arity$variadic = (function (coll,val,p__67789){
var vec__67790 = p__67789;
var seq_SINGLEQUOTE_d_map_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67790,(0),null);
...
if(cljs.core.truth_((function (){var and__5139__auto__ = seq_SINGLEQUOTE_d_map_QMARK_;
...
/** @this {Function} */
(devtools.formatters.state.seek_path_segment.cljs$lang$applyTo = (function (seq67771){
var G__67772 = cljs.core.first(seq67771);
var seq67771__$1 = cljs.core.next(seq67771);
var G__67773 = cljs.core.first(seq67771__$1);
var seq67771__$2 = cljs.core.next(seq67771__$1);
var self__5860__auto__ = this;
return self__5860__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67772,G__67773,seq67771__$2);
}));
...
var valid_kw_QMARK_ = (function (){var and__5139__auto__ = first_kw;
if(cljs.core.truth_(and__5139__auto__)){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2((function (){var or__5141__auto__ = path;
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
return cljs.core.PersistentVector.EMPTY;
...
var or__5141__auto__ = devtools.formatters.state.ignore_path_in_fake_vector(parent_object,object,path_info);
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
var or__5141__auto____$1 = devtools.formatters.state.find_path_in_fake_vector(parent_object,path_info);
if(cljs.core.truth_(or__5141__auto____$1)){
return or__5141__auto____$1;
} else {
var or__5141__auto____$2 = devtools.formatters.state.find_path(parent_object,object,path_info);
