...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__106636,style_created_handler){
var map__106637 = p__106636;
var map__106637__$1 = cljs.core.__destructure_map(map__106637);
var style = map__106637__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106637__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106637__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__106638_106714 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__106638_106714) : style_created_handler.call(null,G__106638_106714));

var seq__106639 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__106640 = null;
var count__106641 = (0);
var i__106642 = (0);
while(true){
if((i__106642 < count__106641)){
var sub_style = chunk__106640.cljs$core$IIndexed$_nth$arity$2(null,i__106642);
var G__106647_106720 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__106648_106721 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__106647_106720,G__106648_106721) : stylefy.impl.styles.create_style_BANG_.call(null,G__106647_106720,G__106648_106721));


var G__106723 = seq__106639;
var G__106724 = chunk__106640;
var G__106725 = count__106641;
var G__106726 = (i__106642 + (1));
seq__106639 = G__106723;
chunk__106640 = G__106724;
count__106641 = G__106725;
i__106642 = G__106726;
continue;
} else {
var temp__5823__auto__ = cljs.core.seq(seq__106639);
if(temp__5823__auto__){
var seq__106639__$1 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__106639__$1)){
var c__5548__auto__ = cljs.core.chunk_first(seq__106639__$1);
var G__106727 = cljs.core.chunk_rest(seq__106639__$1);
var G__106728 = c__5548__auto__;
var G__106729 = cljs.core.count(c__5548__auto__);
var G__106730 = (0);
seq__106639 = G__106727;
chunk__106640 = G__106728;
count__106641 = G__106729;
i__106642 = G__106730;
continue;
} else {
var sub_style = cljs.core.first(seq__106639__$1);
var G__106649_106732 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__106650_106733 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__106649_106732,G__106650_106733) : stylefy.impl.styles.create_style_BANG_.call(null,G__106649_106732,G__106650_106733));


var G__106734 = cljs.core.next(seq__106639__$1);
var G__106735 = null;
var G__106736 = (0);
var G__106737 = (0);
seq__106639 = G__106734;
chunk__106640 = G__106735;
count__106641 = G__106736;
i__106642 = G__106737;
continue;
}
} else {
...
if((((class$ == null)) || (((typeof class$ === 'string') || ((((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__106653_SHARP_){
return ((typeof p1__106653_SHARP_ === 'string') || ((((p1__106653_SHARP_ instanceof cljs.core.Keyword)) || ((p1__106653_SHARP_ == null)))));
}),class$)))))))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__106653#] (or (string? p1__106653#) (keyword? p1__106653#) (nil? p1__106653#))) class)))"].join('')));
}
});
/**
...
if(cljs.core.truth_((function (){var or__5025__auto__ = cljs.core.empty_QMARK_(style);
if(or__5025__auto__){
...
var len__5749__auto___106752 = arguments.length;
var i__5750__auto___106753 = (0);
while(true){
if((i__5750__auto___106753 < len__5749__auto___106752)){
args__5755__auto__.push((arguments[i__5750__auto___106753]));

var G__106754 = (i__5750__auto___106753 + (1));
i__5750__auto___106753 = G__106754;
continue;
} else {
}
break;
...
return stylefy.impl.styles.sub_style.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__5756__auto__);
});

(stylefy.impl.styles.sub_style.cljs$core$IFn$_invoke$arity$variadic = (function (style,sub_styles){
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__106677_SHARP_,p2__106678_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__106677_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__106678_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq106679){
var G__106680 = cljs.core.first(seq106679);
var seq106679__$1 = cljs.core.next(seq106679);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__106680,seq106679__$1);
}));

stylefy.impl.styles.prepare_styles = (function stylefy$impl$styles$prepare_styles(var_args){
var G__106682 = arguments.length;
switch (G__106682) {
case 1:
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__106685){
var map__106686 = p__106685;
var map__106686__$1 = cljs.core.__destructure_map(map__106686);
var _options = map__106686__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106686__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_106763__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__106687_106764 = cljs.core.seq(styles_106763__$1);
var chunk__106688_106765 = null;
var count__106689_106766 = (0);
var i__106690_106767 = (0);
while(true){
if((i__106690_106767 < count__106689_106766)){
var style_106768 = chunk__106688_106765.cljs$core$IIndexed$_nth$arity$2(null,i__106690_106767);
stylefy.impl.styles.use_style_BANG_(style_106768,cljs.core.PersistentArrayMap.EMPTY,((function (seq__106687_106764,chunk__106688_106765,count__106689_106766,i__106690_106767,style_106768,styles_106763__$1,map__106686,map__106686__$1,_options,request_dom_update_after_done_QMARK_){
return (function (style__$1){
return stylefy.impl.dom.add_style(cljs.core.deref(stylefy.impl.dom.dom),style__$1);
});})(seq__106687_106764,chunk__106688_106765,count__106689_106766,i__106690_106767,style_106768,styles_106763__$1,map__106686,map__106686__$1,_options,request_dom_update_after_done_QMARK_))
);

var temp__5823__auto___106769 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_106768));
if(cljs.core.truth_(temp__5823__auto___106769)){
var sub_styles_106771 = temp__5823__auto___106769;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_106771,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__106772 = seq__106687_106764;
var G__106773 = chunk__106688_106765;
var G__106774 = count__106689_106766;
var G__106775 = (i__106690_106767 + (1));
seq__106687_106764 = G__106772;
chunk__106688_106765 = G__106773;
count__106689_106766 = G__106774;
i__106690_106767 = G__106775;
continue;
} else {
var temp__5823__auto___106776 = cljs.core.seq(seq__106687_106764);
if(temp__5823__auto___106776){
var seq__106687_106780__$1 = temp__5823__auto___106776;
if(cljs.core.chunked_seq_QMARK_(seq__106687_106780__$1)){
var c__5548__auto___106782 = cljs.core.chunk_first(seq__106687_106780__$1);
var G__106783 = cljs.core.chunk_rest(seq__106687_106780__$1);
var G__106784 = c__5548__auto___106782;
var G__106785 = cljs.core.count(c__5548__auto___106782);
var G__106786 = (0);
seq__106687_106764 = G__106783;
chunk__106688_106765 = G__106784;
count__106689_106766 = G__106785;
i__106690_106767 = G__106786;
continue;
} else {
var style_106787 = cljs.core.first(seq__106687_106780__$1);
stylefy.impl.styles.use_style_BANG_(style_106787,cljs.core.PersistentArrayMap.EMPTY,((function (seq__106687_106764,chunk__106688_106765,count__106689_106766,i__106690_106767,style_106787,seq__106687_106780__$1,temp__5823__auto___106776,styles_106763__$1,map__106686,map__106686__$1,_options,request_dom_update_after_done_QMARK_){
return (function (style__$1){
return stylefy.impl.dom.add_style(cljs.core.deref(stylefy.impl.dom.dom),style__$1);
});})(seq__106687_106764,chunk__106688_106765,count__106689_106766,i__106690_106767,style_106787,seq__106687_106780__$1,temp__5823__auto___106776,styles_106763__$1,map__106686,map__106686__$1,_options,request_dom_update_after_done_QMARK_))
);

var temp__5823__auto___106788__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_106787));
if(cljs.core.truth_(temp__5823__auto___106788__$1)){
var sub_styles_106790 = temp__5823__auto___106788__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_106790,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__106791 = cljs.core.next(seq__106687_106780__$1);
var G__106792 = null;
var G__106793 = (0);
var G__106794 = (0);
seq__106687_106764 = G__106791;
chunk__106688_106765 = G__106792;
count__106689_106766 = G__106793;
i__106690_106767 = G__106794;
continue;
}
} else {
}
