...
var len__5875__auto___69929 = arguments.length;
var i__5876__auto___69934 = (0);
while(true){
if((i__5876__auto___69934 < len__5875__auto___69929)){
args_arr__5900__auto__.push((arguments[i__5876__auto___69934]));

var G__69941 = (i__5876__auto___69934 + (1));
i__5876__auto___69934 = G__69941;
continue;
} else {
}
break;
...
var argseq__5901__auto__ = ((((6) < args_arr__5900__auto__.length))?(new cljs.core.IndexedSeq(args_arr__5900__auto__.slice((6)),(0),null)):null);
return shadow.util.log.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),(arguments[(2)]),(arguments[(3)]),(arguments[(4)]),(arguments[(5)]),argseq__5901__auto__);
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq69745){
var G__69746 = cljs.core.first(seq69745);
var seq69745__$1 = cljs.core.next(seq69745);
var G__69747 = cljs.core.first(seq69745__$1);
var seq69745__$2 = cljs.core.next(seq69745__$1);
var G__69748 = cljs.core.first(seq69745__$2);
var seq69745__$3 = cljs.core.next(seq69745__$2);
var G__69749 = cljs.core.first(seq69745__$3);
var seq69745__$4 = cljs.core.next(seq69745__$3);
var G__69750 = cljs.core.first(seq69745__$4);
var seq69745__$5 = cljs.core.next(seq69745__$4);
var G__69754 = cljs.core.first(seq69745__$5);
var seq69745__$6 = cljs.core.next(seq69745__$5);
var self__5860__auto__ = this;
return self__5860__auto__.cljs$core$IFn$_invoke$arity$variadic(G__69746,G__69747,G__69748,G__69749,G__69750,G__69754,seq69745__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__69828){
var vec__69829 = p__69828;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69829,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69829,(1),null);
