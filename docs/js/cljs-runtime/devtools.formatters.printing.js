...
var len__5875__auto___68724 = arguments.length;
var i__5876__auto___68725 = (0);
while(true){
if((i__5876__auto___68725 < len__5875__auto___68724)){
args__5881__auto__.push((arguments[i__5876__auto___68725]));

var G__68726 = (i__5876__auto___68725 + (1));
i__5876__auto___68725 = G__68726;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5882__auto__);
});
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq68644){
var G__68645 = cljs.core.first(seq68644);
var seq68644__$1 = cljs.core.next(seq68644);
var G__68646 = cljs.core.first(seq68644__$1);
var seq68644__$2 = cljs.core.next(seq68644__$1);
var self__5860__auto__ = this;
return self__5860__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68645,G__68646,seq68644__$2);
}));
...
if(cljs.core.truth_((function (){var or__5141__auto__ = devtools.formatters.helpers.directly_printable_QMARK_(value);
if(or__5141__auto__){
...
(devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__5433__auto__,writer__5434__auto__,opt__5435__auto__){
return cljs.core._write(writer__5434__auto__,"devtools.formatters.printing/TemplateWriter");
}));
...
if(cljs.core.truth_((function (){var and__5139__auto__ = cljs.core.not(devtools.formatters.printing.already_reference_QMARK_(group));
if(and__5139__auto__){
var or__5141__auto__ = devtools.formatters.helpers.expandable_QMARK_(obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__68662_SHARP_){
return (!((cljs.core.meta(p1__68662_SHARP_) == null)));
})))){
...
if(cljs.core.truth_((function (){var and__5139__auto__ = devtools.prefs.pref(new cljs.core.Keyword(null,"render-path-annotations","render-path-annotations",-1890931512));
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68685__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if((function (){var or__5141__auto__ = (function (){try{if((!((obj == null)))){
...
}catch (e68686){var _e__61495__auto__ = e68686;
return false;
}})();
if(or__5141__auto__){
return or__5141__auto__;
...
}catch (e68688){var _e__61495__auto__ = e68688;
return false;
}}
})()){
...
var _STAR_current_state_STAR__orig_val__68693 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__68694 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__68694);
...
var map__68698 = opts;
var map__68698__$1 = cljs.core.__destructure_map(map__68698);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68698__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__68693);
}});
...
var temp__5821__auto___68772 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5821__auto___68772)){
var managed_print_level_68773 = temp__5821__auto___68772;
var _STAR_print_level_STAR__orig_val__68711_68774 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__68712_68775 = managed_print_level_68773;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__68712_68775);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__68701_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__68701_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__68711_68774);
}} else {
job_fn();
}
