shadow$provide.module$node_modules$react_dom$cjs$react_dom_server_legacy_browser_production_min = function(global, require, module, exports) {
  function l(a) {
    ...
    for (var d in c) {
      if (p.call(c, d)) {
        ...
        if (null != f && "boolean" !== typeof f && "" !== f) {
          ...
          b ? (b = !1, a.push(' style\x3d"', e, ":", f)) : a.push(";", e, ":", f);
        }
      }
    }
    b || a.push('"');
      ...
      if (b = t.hasOwnProperty(c) ? t[c] : null, null !== b) {
        ...
        switch(b.type) {
          case 3:
            ...
            break;
          case 4:
            !0 === d ? a.push(" ", c, '\x3d""') : !1 !== d && a.push(" ", c, '\x3d"', v(d), '"');
            break;
          case 5:
            isNaN(d) || a.push(" ", c, '\x3d"', v(d), '"');
            break;
          case 6:
            !isNaN(d) && 1 <= d && a.push(" ", c, '\x3d"', v(d), '"');
            break;
          default:
            b.sanitizeURL && (d = "" + d), a.push(" ", c, '\x3d"', v(d), '"');
        }
      } else if (ja(c)) {
        switch(typeof d) {
          case "function":
  ...
  function ya(a, b, c, d, f) {
    switch(b) {
      ...
      case "option":
        ...
        if (null != g) {
          if (c = null !== k ? "" + k : ua(h), qa(g)) {
            ...
            "" + g === c && a.push(' selected\x3d""');
          }
        } else {
          m && a.push(' selected\x3d""');
        }
        a.push("\x3e");
        y(a, n, h);
        return h;
      ...
      case "missing-glyph":
        return va(a, c, b, d);
      case "html":
        return 0 === f.insertionMode && a.push("\x3c!DOCTYPE html\x3e"), va(a, c, b, d);
      default:
          ...
          if (p.call(c, m) && (h = c[m], null != h)) {
            switch(m) {
              ...
              case "suppressHydrationWarning":
                break;
              default:
                ja(m) && "function" !== typeof h && "symbol" !== typeof h && a.push(" ", m, '\x3d"', v(h), '"');
            }
          }
        }
        a.push("\x3e");
  ...
  function za(a, b, c) {
    a.push('\x3c!--$?--\x3e\x3ctemplate id\x3d"');
    if (null === c) {
      throw Error(l(395));
    }
    a.push(c);
    return a.push('"\x3e\x3c/template\x3e');
  }
  function Aa(a, b, c, d) {
    switch(c.insertionMode) {
      case 0:
      case 1:
        return a.push('\x3cdiv hidden id\x3d"'), a.push(b.segmentPrefix), b = d.toString(16), a.push(b), a.push('"\x3e');
      case 2:
        return a.push('\x3csvg aria-hidden\x3d"true" style\x3d"display:none" id\x3d"'), a.push(b.segmentPrefix), b = d.toString(16), a.push(b), a.push('"\x3e');
      case 3:
        return a.push('\x3cmath aria-hidden\x3d"true" style\x3d"display:none" id\x3d"'), a.push(b.segmentPrefix), b = d.toString(16), a.push(b), a.push('"\x3e');
      case 4:
        return a.push('\x3ctable hidden id\x3d"'), a.push(b.segmentPrefix), b = d.toString(16), a.push(b), a.push('"\x3e');
      case 5:
        return a.push('\x3ctable hidden\x3e\x3ctbody id\x3d"'), a.push(b.segmentPrefix), b = d.toString(16), a.push(b), a.push('"\x3e');
      case 6:
        return a.push('\x3ctable hidden\x3e\x3ctr id\x3d"'), a.push(b.segmentPrefix), b = d.toString(16), a.push(b), a.push('"\x3e');
      case 7:
        return a.push('\x3ctable hidden\x3e\x3ccolgroup id\x3d"'), a.push(b.segmentPrefix), b = d.toString(16), a.push(b), a.push('"\x3e');
      default:
        throw Error(l(397));
    }
  }
  function Ba(a, b) {
    switch(b.insertionMode) {
      case 0:
      case 1:
        return a.push("\x3c/div\x3e");
      case 2:
        return a.push("\x3c/svg\x3e");
      case 3:
        return a.push("\x3c/math\x3e");
      case 4:
        return a.push("\x3c/table\x3e");
      case 5:
        return a.push("\x3c/tbody\x3e\x3c/table\x3e");
      case 6:
        return a.push("\x3c/tr\x3e\x3c/table\x3e");
      case 7:
        return a.push("\x3c/colgroup\x3e\x3c/table\x3e");
      default:
        throw Error(l(397));
    }
  }
  ...
  function Ea(a, b) {
    b = void 0 === b ? "" : b;
    return {bootstrapChunks:[], startInlineScript:"\x3cscript\x3e", placeholderPrefix:b + "P:", segmentPrefix:b + "S:", boundaryPrefix:b + "B:", idPrefix:b, nextSuspenseID:0, sentCompleteSegmentFunction:!1, sentCompleteBoundaryFunction:!1, sentClientRenderFunction:!1, generateStaticMarkup:a};
  }
  function Fa(a, b, c, d) {
      ...
      switch(c) {
        ...
        case Oa:
          a: {
            ...
            b.blockedSegment = m;
            try {
              if (Hb(a, b, d), a.responseState.generateStaticMarkup || m.lastPushedText && m.textEmbedded && m.chunks.push("\x3c!-- --\x3e"), m.status = 1, Y(h, m), 0 === h.pendingTasks) {
                break a;
              }
            } catch (n) {
  ...
  function Z(a, b, c) {
    ...
    switch(c.status) {
      case 0:
        ...
        c.textEmbedded = !1;
        a = a.responseState;
        b.push('\x3ctemplate id\x3d"');
        b.push(a.placeholderPrefix);
        a = d.toString(16);
        b.push(a);
        return b.push('"\x3e\x3c/template\x3e');
      case 1:
        c.status = 2;
        var f = !0;
        d = c.chunks;
  ...
  function Nb(a, b, c) {
    ...
    if (d.forceClientRender) {
      return a.responseState.generateStaticMarkup || (d = d.errorDigest, b.push("\x3c!--$!--\x3e"), b.push("\x3ctemplate"), d && (b.push(' data-dgst\x3d"'), d = v(d), b.push(d), b.push('"')), b.push("\x3e\x3c/template\x3e")), Z(a, b, c), a = a.responseState.generateStaticMarkup ? !0 : b.push("\x3c!--/$--\x3e"), a;
    }
    if (0 < d.pendingTasks) {
    ...
    if (d.byteSize > a.progressiveChunkSize) {
      return d.rootSegmentID = a.nextSegmentId++, a.completedBoundaries.push(d), za(b, a.responseState, d.id), Z(a, b, c), b.push("\x3c!--/$--\x3e");
    }
    ...
    Nb(a, b, c[0]);
    return a = a.responseState.generateStaticMarkup ? !0 : b.push("\x3c!--/$--\x3e");
  }
  function Ob(a, b, c) {
  ...
  function Qb(a, b, c, d) {
    ...
    a = a.responseState;
    b.push(a.startInlineScript);
    a.sentCompleteSegmentFunction ? b.push('$RS("') : (a.sentCompleteSegmentFunction = !0, b.push('function $RS(a,b){a\x3ddocument.getElementById(a);b\x3ddocument.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)};$RS("'));
    b.push(a.segmentPrefix);
    f = f.toString(16);
    b.push(f);
    b.push('","');
  ...
  function Mb(a, b) {
    try {
      ...
      for (e = 0; e < f.length; e++) {
        ...
        h.sentClientRenderFunction ? d.push('$RX("') : (h.sentClientRenderFunction = !0, d.push('function $RX(b,c,d,e){var a\x3ddocument.getElementById(b);a\x26\x26(b\x3da.previousSibling,b.data\x3d"$!",a\x3da.dataset,c\x26\x26(a.dgst\x3dc),d\x26\x26(a.msg\x3dd),e\x26\x26(a.stck\x3de),b._reactRetry\x26\x26b._reactRetry())};$RX("'));
        if (null === k) {
          throw Error(l(395));
        }
        d.push(k);
  ...
  function Tb(a, b, c, d) {
    var f = !1, e = null, g = "", h = {push:function(a) {
      null !== a && (g += a);
      return !0;
    }, destroy:function(a) {
      f = !0;
  ...
  var aa = require("module$node_modules$react$index"), p = Object.prototype.hasOwnProperty, fa = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, ha = {}, ia = {}, t = {};
  ...
  tabSize:!0, widows:!0, zIndex:!0, zoom:!0, fillOpacity:!0, floodOpacity:!0, stopOpacity:!0, strokeDasharray:!0, strokeDashoffset:!0, strokeMiterlimit:!0, strokeOpacity:!0, strokeWidth:!0}, ma = ["Webkit", "ms", "Moz", "O"];
  ...
  var na = /["'&<>]/, oa = /([A-Z])/g, pa = /^ms-/, qa = Array.isArray, sa = new Map(), wa = /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/, xa = new Map(), Ca = /[<\u2028\u2029]/g, B = Object.assign, Ga = Symbol.for("react.element"), Ha = Symbol.for("react.portal"), Ia = Symbol.for("react.fragment"), Ja = Symbol.for("react.strict_mode"), Ka = Symbol.for("react.profiler"), La = Symbol.for("react.provider"), Ma = Symbol.for("react.context"), Na = Symbol.for("react.forward_ref"), Oa = Symbol.for("react.suspense"), 
  Pa = Symbol.for("react.suspense_list"), Qa = Symbol.for("react.memo"), Ra = Symbol.for("react.lazy"), Sa = Symbol.for("react.scope"), Ta = Symbol.for("react.debug_trace_mode"), Ua = Symbol.for("react.legacy_hidden"), Va = Symbol.for("react.default_value"), Wa = Symbol.iterator, Ya = {}, E = null, db = {isMounted:function() {
    return !1;
  ...
  }}, fb = {id:1, overflow:""}, H = Math.clz32 ? Math.clz32 : hb, ib = Math.log, jb = Math.LN2, lb = "function" === typeof Object.is ? Object.is : kb, I = null, ob = null, J = null, K = null, L = !1, M = !1, N = 0, O = null, P = 0, xb = {readContext:function(a) {
...
//# sourceMappingURL=module$node_modules$react_dom$cjs$react_dom_server_legacy_browser_production_min.js.map
