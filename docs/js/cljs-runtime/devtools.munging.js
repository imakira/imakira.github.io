...
var o92202 = temp__5821__auto__;
var temp__5821__auto____$1 = (o92202["core"]);
if(cljs.core.truth_(temp__5821__auto____$1)){
var o92203 = temp__5821__auto____$1;
return (o92203["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__36179__auto__ = f;
return (o__36179__auto__["toString"]).call(o__36179__auto__);
} else {
return "";
}
}catch (e92206){var _ = e92206;
return "";
}});
...
try{var o__36179__auto___92881 = t;
(o__36179__auto___92881["cljs$lang$ctorPrWriter"]).call(o__36179__auto___92881,t,writer);
}catch (e92219){var __92883 = e92219;
}
...
var char_code = (function (){var o__36179__auto__ = (new String(char$));
return (o__36179__auto__["charCodeAt"]).call(o__36179__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__36179__auto__ = String;
return (o__36179__auto__["fromCharCode"]).call(o__36179__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__92272 = num_code;
switch (G__92272) {
case (1):
return (185);
...
var o__36179__auto__ = String;
return (o__36179__auto__["fromCharCode"]).call(o__36179__auto__,superscript_code);
});
/**
...
}catch (e92353){var _e__36186__auto__ = e92353;
return false;
}})())){
...
var vec__92361 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92361,(0),null);
...
var len__5749__auto___92895 = arguments.length;
var i__5750__auto___92896 = (0);
while(true){
if((i__5750__auto___92896 < len__5749__auto___92895)){
args__5755__auto__.push((arguments[i__5750__auto___92896]));

var G__92897 = (i__5750__auto___92896 + (1));
i__5750__auto___92896 = G__92897;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__92439){
var vec__92440 = p__92439;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92440,(0),null);
...
var G__92903 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__92904 = cljs.core.butlast(remaining_tokens);
name_tokens = G__92903;
remaining_tokens = G__92904;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq92418){
var G__92419 = cljs.core.first(seq92418);
var seq92418__$1 = cljs.core.next(seq92418);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__92419,seq92418__$1);
}));
...
var vec__92492 = cljs.core.split_with((function (p1__92490_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__92490_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92492,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92492,(1),null);
...
var vec__92533 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92533,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92533,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__92909 = cljs.core.rest(remaining_tokens);
var G__92910 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__92909;
name_tokens = G__92910;
continue;
} else {
...
var vec__92568 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92568,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92568,(1),null);
var vec__92571 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92571,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92571,(1),null);
var vec__92574 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92574,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92574,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92574,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92574,(3),null);
...
var vec__92593 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92593,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92593,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92593,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92593,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92593,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92593,(5),null);
...
if(cljs.core.truth_(temp__5821__auto__)){
var vec__92609 = temp__5821__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92609,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92609,(1),null);
var vec__92613 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92613,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92613,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__92623 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__92623) : devtools.munging.parse_fn_info_deep.call(null,G__92623));
})()));
}
} else {
return fn_info;
...
var G__92929 = (arity + (1));
var G__92930 = (function (){var temp__5821__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5821__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__92657){
var vec__92658 = p__92657;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92658,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92658,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__92676_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__92676_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__92677_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__92677_SHARP_);
}),sorted_infos);
...
var args__5755__auto__ = [];
var len__5749__auto___92933 = arguments.length;
var i__5750__auto___92934 = (0);
while(true){
if((i__5750__auto___92934 < len__5749__auto___92933)){
args__5755__auto__.push((arguments[i__5750__auto___92934]));

var G__92935 = (i__5750__auto___92934 + (1));
i__5750__auto___92934 = G__92935;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__92691){
var vec__92693 = p__92691;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92693,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq92685){
var G__92686 = cljs.core.first(seq92685);
var seq92685__$1 = cljs.core.next(seq92685);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__92686,seq92685__$1);
}));
...
var G__92704 = arg;
var G__92704__$1 = (((G__92704 instanceof cljs.core.Keyword))?G__92704.fqn:null);
switch (G__92704__$1) {
...
var map__92727 = options;
var map__92727__$1 = cljs.core.__destructure_map(map__92727);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__92727__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__92727__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__92727__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__92727__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__92728 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92728,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92728,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92728,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92728,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92728,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92728,(5),null);
...
var o__36179__auto__ = f;
return (o__36179__auto__["getBasis"]).call(o__36179__auto__);
});
/**
...
}catch (e92751){var _e__36186__auto__ = e92751;
...
var G__92949 = (obj[cljs.core.first(path)]);
var G__92950 = cljs.core.rest(path);
obj = G__92949;
path = G__92950;
continue;
} else {
...
var _STAR_ = (function (accum,p__92836){
var vec__92837 = p__92836;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92837,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92837,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__92847){
var vec__92850 = p__92847;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92850,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92850,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92850,(2),null);
...
var post_process = (function (p__92863){
var vec__92864 = p__92863;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92864,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__92864,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__92859_SHARP_){
return (obj[cljs.core.first(p1__92859_SHARP_)]);
}),sorted_matches);
