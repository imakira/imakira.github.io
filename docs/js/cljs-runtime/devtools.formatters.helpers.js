...
var G__70738 = devtools.prefs.pref(v);
v = G__70738;
continue;
} else {
return v;
...
}catch (e70682){var _e__69162__auto__ = e70682;
return false;
}})();
if(or__5142__auto__){
...
}catch (e70688){var _e__69162__auto__ = e70688;
return false;
}})();
...
}catch (e70696){var _e__69162__auto__ = e70696;
return false;
}}
}
});
...
var vec__70716 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70716,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70716,(1),null);
...
return cljs.core.some((function (p1__70728_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__70728_SHARP_);
}),template);
});
