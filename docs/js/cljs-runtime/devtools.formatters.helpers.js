...
var G__68633 = devtools.prefs.pref(v);
v = G__68633;
continue;
} else {
return v;
...
var and__5139__auto__ = cljs.core.not(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__5139__auto__){
var and__5139__auto____$1 = (!(cljs.core.var_QMARK_(value)));
...
var or__5141__auto__ = (function (){try{if((!((value == null)))){
...
}catch (e68591){var _e__61495__auto__ = e68591;
return false;
}})();
if(or__5141__auto__){
return or__5141__auto__;
} else {
var or__5141__auto____$1 = (function (){try{if((!((value == null)))){
...
}catch (e68603){var _e__61495__auto__ = e68603;
return false;
}})();
...
}catch (e68606){var _e__61495__auto__ = e68606;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__5139__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__5139__auto__)){
var and__5139__auto____$1 = (!(devtools.formatters.helpers.is_prototype_QMARK_(f)));
if(and__5139__auto____$1){
...
var and__5139__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__5139__auto__)){
...
var or__5141__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
...
var and__5139__auto__ = (function (){var or__5141__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__5141__auto__)){
return or__5141__auto__;
} else {
...
var vec__68617 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68617,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68617,(1),null);
...
var and__5139__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__5139__auto__)){
...
return cljs.core.some((function (p1__68621_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__68621_SHARP_);
}),template);
});
