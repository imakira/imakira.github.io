...
return cljs.core.some((function (p1__75151_SHARP_){
if(clojure.string.starts_with_QMARK_(p1__75151_SHARP_,"G_")){
return (component_type === (component_type[p1__75151_SHARP_]));
} else {
return null;
}
...
if(cljs.core.truth_((function (){var and__5139__auto__ = cljs.core.not(component_type.uix_component_QMARK_);
...
var name_str_75245 = (function (){var or__5141__auto__ = component_type.displayName;
...
throw (new Error((""+"Invalid use of Reagent component "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(name_str_75245)+" in `$` form.\n"+"UIx doesn't know how to render Reagent components.\n"+"Reagent element should be Hiccup wrapped with r/as-element, i.e. (r/as-element ["+cljs.core.str.cljs$core$IFn$_invoke$arity$1(name_str_75245)+"])")));
} else {
}
...
var and__5139__auto__ = cljs.core.not(x.hasOwnProperty("$$typeof"));
if(and__5139__auto__){
var G__75182 = x;
var G__75182__$1 = (((G__75182 == null))?null:G__75182.constructor);
if((G__75182__$1 == null)){
return null;
} else {
return (G__75182__$1 === Object);
}
} else {
return and__5139__auto__;
}
...
var and__5139__auto__ = ((typeof tag === 'string') || (cljs.core.not(tag.uix_component_QMARK_)));
if(and__5139__auto__){
var and__5139__auto____$1 = props;
