...
shadow$provide.module$node_modules$$js_joda$locale_en_us$dist$index = function(require, module, exports) {
  (function(root, factory) {
    typeof exports === "object" && typeof module === "object" ? module.exports = factory(require("module$node_modules$$js_joda$core$dist$js_joda")) : typeof define === "function" && define.amd ? define(["@js-joda/core"], factory) : typeof exports === "object" ? exports.JSJodaLocale = factory(require("module$node_modules$$js_joda$core$dist$js_joda")) : root.JSJodaLocale = factory(root.JSJoda);
    ...
    return function(modules) {
      ...
      __webpack_require__.t = function(value, mode) {
        ...
        if (mode & 8 || mode & 4 && typeof value === "object" && value && value.__esModule) {
          return value;
        }
    ...
    }, "./node_modules/cldr-data/availableLocales.json":function(module) {
    ...
    }, "./node_modules/cldr-data/main/en/ca-gregorian.json":function(module) {
    ...
    }, "./node_modules/cldr-data/main/en/timeZoneNames.json":function(module) {
    ...
    }, "./node_modules/cldr-data/supplemental/likelySubtags.json":function(module) {
    ...
    }, "./node_modules/cldr-data/supplemental/metaZones.json":function(module) {
    ...
    }, "./node_modules/cldr-data/supplemental/weekData.json":function(module) {
    ...
    }, "./node_modules/cldrjs/dist/cldr.js":function(module, exports, __webpack_require__) {
      ...
      (function(root, factory) {
        ...
        var arrayIsArray = Array.isArray || function(obj) {
        ...
        }, pathNormalize = function(path, attributes) {
          arrayIsArray(path) && (path = path.join("/"));
          ...
          return path.split("/");
        }, arraySome = function(array, callback) {
          var length;
          if (array.some) {
          ...
          return !1;
        }, coreLikelySubtags = function(Cldr, cldr, subtags, options) {
          var language = subtags[0], script = subtags[1], sep = Cldr.localeSep;
          Cldr = subtags[2];
          subtags = subtags.slice(3, 4);
          options = options || {};
          if (language !== "und" && script !== "Zzzz" && Cldr !== "ZZ") {
            return [language, script, Cldr].concat(subtags);
          }
          if (typeof cldr.get("supplemental/likelySubtags") !== "undefined") {
            if (arraySome([[language, script, Cldr], [language, Cldr], [language, script], [language], ["und", script]], function(test) {
              return match = !/\b(Zzzz|ZZ)\b/.test(test.join(sep)) && cldr.get(["supplemental/likelySubtags", test.join(sep)]);
            })) {
              var match = match.split(sep);
              return [language !== "und" ? language : match[0], script !== "Zzzz" ? script : match[1], Cldr !== "ZZ" ? Cldr : match[2]].concat(subtags);
            }
            if (options.force) {
              return cldr.get("supplemental/likelySubtags/und").split(sep);
            }
          }
        }, coreRemoveLikelySubtags = function(Cldr, cldr, maxLanguageId) {
          var match, language = maxLanguageId[0], script = maxLanguageId[1], territory = maxLanguageId[2], variants = maxLanguageId[3];
          return arraySome([[[language, "Zzzz", "ZZ"], [language]], [[language, "Zzzz", territory], [language, territory]], [[language, script, "ZZ"], [language, script]]], function(test) {
            var result = coreLikelySubtags(Cldr, cldr, test[0]);
            match = test[1];
            return result && result[0] === maxLanguageId[0] && result[1] === maxLanguageId[1] && result[2] === maxLanguageId[2];
          }) ? (variants && match.push(variants), match) : maxLanguageId;
        }, coreSubtags = function(locale) {
          var subtags = [];
          locale = locale.replace(/_/, "-");
          var aux = locale.split("-u-");
          aux[1] && (aux[1] = aux[1].split("-t-"), locale = aux[0] + (aux[1][1] ? "-t-" + aux[1][1] : ""), subtags[4] = aux[1][0]);
          aux = locale.split("-t-")[0].match(/^(([a-z]{2,3})(-([A-Z][a-z]{3}))?(-([A-Z]{2}|[0-9]{3}))?)((-([a-zA-Z0-9]{5,8}|[0-9][a-zA-Z0-9]{3}))*)$|^(root)$/);
          if (aux === null) {
            return ["und", "Zzzz", "ZZ"];
          }
          ...
          subtags[2] = aux[6] || "ZZ";
          aux[7] && aux[7].length && (subtags[3] = aux[7].slice(1));
          return subtags;
        ...
        }, bundleLookup = function(Cldr, cldr, minLanguageId) {
          var availableBundleMap = Cldr._availableBundleMap, availableBundleMapQueue = Cldr._availableBundleMapQueue;
          availableBundleMapQueue.length && (arrayForEach(availableBundleMapQueue, function(bundle) {
            var existing = coreSubtags(bundle);
            existing = coreLikelySubtags(Cldr, cldr, existing);
            var minBundle = coreRemoveLikelySubtags(Cldr, cldr, existing);
            minBundle = minBundle.join(Cldr.localeSep);
            (existing = availableBundleMap[minBundle]) && existing.length < bundle.length || (availableBundleMap[minBundle] = bundle);
          ...
          return result;
        }, createError = function(code, attributes) {
          var message = code + (attributes && JSON ? ": " + JSON.stringify(attributes) : "");
          ...
          return error;
        }, validatePresence = function(value, name) {
          name = {name};
          if (typeof value === "undefined") {
            throw createError("E_MISSING_PARAMETER", name);
          }
        }, validateType = function(value, name, check, expected) {
          value = {expected, name, value};
          if (!check) {
            throw createError("E_INVALID_PAR_TYPE", value);
          }
        }, validateTypePath = function(value, name) {
          validateType(value, name, typeof value === "string" || arrayIsArray(value), "String or Array");
        }, validateTypePlainObject = function(value, name) {
          validateType(value, name, typeof value === "undefined" || value !== null && "" + value === "[object Object]", "Plain Object");
        }, resourceGet = function(data, path) {
          var node = data, length = path.length;
          for (data = 0; data < length - 1; data++) {
            if (node = node[path[data]], !node) {
              return;
            }
          }
          return node[path[data]];
        }, alwaysArray = function(somethingOrArray) {
          ...
          var merge = function() {
            ...
            arrayForEach(sources, function(source) {
              for (var prop in source) {
                prop in destination && typeof destination[prop] === "object" && !arrayIsArray(destination[prop]) ? destination[prop] = merge(destination[prop], source[prop]) : destination[prop] = source[prop];
              }
            });
            return destination;
          };
          return merge;
        }(), coreLoad = function(Cldr, source, jsons) {
          var i, j;
          validatePresence(jsons[0], "json");
          for (i = 0; i < jsons.length; i++) {
            var json = alwaysArray(jsons[i]);
            for (j = 0; j < json.length; j++) {
              validateTypePlainObject(json[j], "json");
              source = jsonMerge(source, json[j]);
              var bundle = void 0, availableBundleMapQueue = Cldr._availableBundleMapQueue, main = resourceGet(json[j], ["main"]);
              if (main) {
                for (bundle in main) {
                  main.hasOwnProperty(bundle) && bundle !== "root" && availableBundleMapQueue.indexOf(bundle) === -1 && availableBundleMapQueue.push(bundle);
                }
              }
            }
          }
          return source;
        }, itemGetResolved = function(Cldr, path, attributes) {
        ...
        Cldr.prototype.init = function(locale) {
          var attributes, sep = Cldr.localeSep, unicodeLocaleExtensionsRaw = "";
          validatePresence(locale, "locale");
          validateType(locale, "locale", typeof locale === "string", "a string");
          var language = coreSubtags(locale);
          if (language.length === 5) {
            var unicodeLocaleExtensions = language.pop();
            unicodeLocaleExtensionsRaw = sep + "u" + sep + unicodeLocaleExtensions;
            language[3] || language.pop();
          }
          var variant = language[3];
          var maxLanguageId = coreLikelySubtags(Cldr, this, language, {force:!0}) || language;
          language = maxLanguageId[0];
          var script = maxLanguageId[1];
          var territory = maxLanguageId[2];
          var minLanguageId = coreRemoveLikelySubtags(Cldr, this, maxLanguageId).join(sep);
          this.attributes = attributes = {bundle:bundleLookup(Cldr, this, minLanguageId), minLanguageId:minLanguageId + unicodeLocaleExtensionsRaw, maxLanguageId:maxLanguageId.join(sep) + unicodeLocaleExtensionsRaw, language, script, territory, region:territory, variant};
          unicodeLocaleExtensions && ("-" + unicodeLocaleExtensions).replace(/-[a-z]{3,8}|(-[a-z]{2})-([a-z]{3,8})/g, function(attribute, key, type) {
            key ? attributes["u" + key] = type : attributes["u" + attribute] = !0;
          });
          this.locale = locale;
        };
        ...
        Cldr.prototype.main = function(path) {
          validatePresence(path, "path");
          validateTypePath(path, "path");
          var attributes = {locale:this.locale};
          if (this.attributes.bundle === null) {
            throw createError("E_MISSING_BUNDLE", attributes);
          }
    ...
    }, "./node_modules/cldrjs/dist/cldr/event.js":function(module, exports, __webpack_require__) {
      ...
      (function(factory) {
        ...
        function validateThenCall(method, self) {
          return function(event, listener) {
            ...
            validateType(event, "event", typeof event === "string" || event instanceof RegExp, "String or RegExp");
            validatePresence(listener, "listener");
            validateType(listener, "listener", typeof listener === "undefined" || typeof listener === "function", "Function");
        ...
        var EventEmitter = function() {
          ...
          proto.getListeners = function(evt) {
            var events = this._getEvents(), key;
          ...
          proto.addListener = function(evt, listener) {
            evt = this.getListenersAsObject(evt);
            var listenerIsWrapped = typeof listener === "object", key;
            for (key in evt) {
              evt.hasOwnProperty(key) && indexOfListener(evt[key], listener) === -1 && evt[key].push(listenerIsWrapped ? listener : {listener, once:!1});
            }
            return this;
          };
          proto.on = alias("addListener");
          proto.addOnceListener = function(evt, listener) {
            return this.addListener(evt, {listener, once:!0});
          };
          ...
          proto.removeListener = function(evt, listener) {
            ...
            for (key in evt) {
              if (evt.hasOwnProperty(key)) {
                var index = indexOfListener(evt[key], listener);
                index !== -1 && evt[key].splice(index, 1);
              }
            }
            return this;
          };
          ...
          proto.manipulateListeners = function(remove, evt, listeners) {
            ...
            remove = remove ? this.removeListeners : this.addListeners;
            if (typeof evt !== "object" || evt instanceof RegExp) {
              ...
              for (i in evt) {
                evt.hasOwnProperty(i) && (value = evt[i]) && (typeof value === "function" ? single.call(this, i, value) : remove.call(this, i, value));
              }
            }
            return this;
          };
          ...
          proto.emitEvent = function(evt, args) {
            var listeners = this.getListenersAsObject(evt), i, key;
        ...
        var superGet, globalEe = new EventEmitter();
        Cldr.off = validateThenCall("off", globalEe);
        Cldr.on = validateThenCall("on", globalEe);
        Cldr.once = validateThenCall("once", globalEe);
        var superInit = Cldr.prototype.init;
        Cldr.prototype.init = function() {
          var ee;
          this.ee = ee = new EventEmitter();
          this.off = validateThenCall("off", ee);
          this.on = validateThenCall("on", ee);
          this.once = validateThenCall("once", ee);
    ...
    }, "./node_modules/cldrjs/dist/cldr/supplemental.js":function(module, exports, __webpack_require__) {
      var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;
      (function(factory) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("./node_modules/cldrjs/dist/cldr.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = factory, __WEBPACK_AMD_DEFINE_RESULT__ = typeof __WEBPACK_AMD_DEFINE_FACTORY__ === "function" ? __WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__) : __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__ !== void 0 && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
      })(function(Cldr) {
        var alwaysArray = Cldr._alwaysArray, supplementalMain = function(cldr) {
          ...
          var supplemental = prepend("supplemental");
    ...
    }, "./node_modules/cldrjs/dist/cldr/unresolved.js":function(module, exports, __webpack_require__) {
      var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;
      (function(factory) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__("./node_modules/cldrjs/dist/cldr.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = factory, __WEBPACK_AMD_DEFINE_RESULT__ = typeof __WEBPACK_AMD_DEFINE_FACTORY__ === "function" ? __WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__) : __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__ !== void 0 && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
      })(function(Cldr) {
        var coreLoad = Cldr._coreLoad, jsonMerge = Cldr._jsonMerge, pathNormalize = Cldr._pathNormalize, resourceGet = Cldr._resourceGet, validatePresence = Cldr._validatePresence, validateTypePath = Cldr._validateTypePath, itemLookup = function() {
          var lookup;
          return lookup = function(Cldr, locale, path, attributes, childLocale) {
            if (typeof locale !== "undefined" && locale !== childLocale) {
              childLocale = pathNormalize(path, attributes);
              var parent = resourceGet(Cldr._resolved, childLocale);
              if (parent !== void 0 && typeof parent !== "object") {
                return parent;
              }
              parent = resourceGet(Cldr._raw, childLocale);
              parent === void 0 && (locale !== "root" ? (parent = pathNormalize(["supplemental/parentLocales/parentLocale", locale]), parent = resourceGet(Cldr._resolved, parent) || resourceGet(Cldr._raw, parent), parent || (parent = (parent = locale.substr(0, locale.lastIndexOf(Cldr.localeSep))) ? parent : "root")) : parent = void 0, parent = lookup(Cldr, parent, path, jsonMerge(attributes, {bundle:parent}), locale));
              if (parent !== void 0) {
                locale = Cldr._resolved;
                path = childLocale.length;
                for (Cldr = 0; Cldr < path - 1; Cldr++) {
                  locale[childLocale[Cldr]] || (locale[childLocale[Cldr]] = {}), locale = locale[childLocale[Cldr]];
                }
                locale[childLocale[Cldr]] = parent;
              }
              return parent;
            }
          };
        ...
        Cldr._eventInit && Cldr._eventInit();
        return Cldr;
      });
    }, "./node_modules/cldrjs/dist/node_main.js":function(module, exports, __webpack_require__) {
    ...
    }, "./src/Locale.js":function(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "_init", function() {
        return _init;
      });
      var _format_cldr_CldrDateTimeTextProvider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/format/cldr/CldrDateTimeTextProvider.js"), Locale = function() {
        function Locale(language) {
          var country = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "", localeString = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "";
        ...
        _createClass(Locale, null, [{key:"getAvailableLocales", value:function() {
          return (new _format_cldr_CldrDateTimeTextProvider__WEBPACK_IMPORTED_MODULE_0__["default"]()).getAvailableLocales();
        }}]);
        _createClass(Locale, [{key:"language", value:function() {
          return this._language;
        }}, {key:"country", value:function() {
          return this._country;
        }}, {key:"localeString", value:function() {
          return this._localeString.length > 0 ? this._localeString : this._country.length > 0 ? "".concat(this._language, "-").concat(this._country) : this._language;
        }}, {key:"toString", value:function() {
          return "Locale[".concat(this.localeString(), "]");
        }}, {key:"equals", value:function(other) {
          return other && other instanceof Locale ? this.localeString() === other.localeString() : !1;
        }}]);
        return Locale;
      }();
    }, "./src/_init.js":function(module, __webpack_exports__, __webpack_require__) {
      __webpack_require__.r(__webpack_exports__);
      module = __webpack_require__("./src/Locale.js");
      __webpack_require__ = __webpack_require__("./src/temporal/WeekFields.js");
      Object(module._init)();
      Object(__webpack_require__._init)();
    }, "./src/format/LocaleDateTimeFormatter.js":function(module, __webpack_exports__, __webpack_require__) {
      ...
      var _js_joda_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("@js-joda/core");
      __webpack_require__.n(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__);
      __webpack_require__("./src/Locale.js");
      var requireNonNull = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__._.assert.requireNonNull, LocaleDateTimeFormatter = function(_DateTimeFormatter) {
        function LocaleDateTimeFormatter() {
          if (!(this instanceof LocaleDateTimeFormatter)) {
            throw new TypeError("Cannot call a class as a function");
          }
          var call = _getPrototypeOf(LocaleDateTimeFormatter).apply(this, arguments);
        ...
        _createClass(LocaleDateTimeFormatter, [{key:"withLocale", value:function(locale) {
          requireNonNull(locale, "locale");
          return locale.equals(this._locale) ? this : new _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.DateTimeFormatter(this._printerParser, locale, this._decimalStyle, this._resolverStyle, this._resolverFields, this._chrono, this._zone);
        }}]);
        return LocaleDateTimeFormatter;
      }(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.DateTimeFormatter);
    }, "./src/format/LocaleStore.js":function(module, __webpack_exports__, __webpack_require__) {
      function _defineProperties(target, props) {
        for (var i = 0; i < props.length; i++) {
          var descriptor = props[i];
          descriptor.enumerable = descriptor.enumerable || !1;
      ...
      __webpack_require__.r(__webpack_exports__);
      __webpack_require__.d(__webpack_exports__, "createEntry", function() {
        return createEntry;
      });
      __webpack_require__.d(__webpack_exports__, "LocaleStore", function() {
        return LocaleStore;
      });
      var createEntry = function(text, field) {
        return {key:text, value:field, toString:function() {
          return text + "-\x3e" + field;
        }};
      }, _comparator = function(obj1, obj2) {
        return obj2.key.length - obj1.key.length;
      }, LocaleStore = function() {
        function LocaleStore(valueTextMap) {
          if (!(this instanceof LocaleStore)) {
            throw new TypeError("Cannot call a class as a function");
          }
          ...
          Object.keys(valueTextMap).forEach(function(style) {
            ...
            Object.keys(valueTextMap[style]).forEach(function(key) {
              ...
              reverse[value] === void 0 && (reverse[value] = createEntry(value, Number.parseInt(key)));
            });
        ...
        _createClass(LocaleStore, [{key:"getText", value:function(value, style) {
          style = this._valueTextMap[style];
          return style != null ? style[value] : null;
        }}, {key:"getTextIterator", value:function(style) {
          style = this._parsable[style];
          return style != null ? style[Symbol.iterator]() : null;
        }}]);
        return LocaleStore;
      }();
    }, "./src/format/cldr/CldrDateTimeFormatterBuilder.js":function(module, __webpack_exports__, __webpack_require__) {
      function _typeof(obj) {
        _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function(obj) {
          return typeof obj;
        } : function(obj) {
      ...
      __webpack_require__("./src/format/parser/LocalizedOffsetPrinterParser.js"), _parser_WeekFieldsPrinterParser__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./src/format/parser/WeekFieldsPrinterParser.js");
      module = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__._.assert;
      var requireNonNull = module.requireNonNull, requireInstance = module.requireInstance, CldrDateTimeFormatterBuilder = function(_DateTimeFormatterBui) {
        function CldrDateTimeFormatterBuilder() {
          if (!(this instanceof CldrDateTimeFormatterBuilder)) {
            throw new TypeError("Cannot call a class as a function");
          }
          var call = _getPrototypeOf(CldrDateTimeFormatterBuilder).apply(this, arguments);
          if (!call || _typeof(call) !== "object" && typeof call !== "function") {
            if (this === void 0) {
              throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            }
        ...
        _createClass(CldrDateTimeFormatterBuilder, [{key:"appendText", value:function(field, styleOrMap) {
          return styleOrMap === void 0 ? this.appendTextField(field) : styleOrMap instanceof _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle ? this.appendTextFieldStyle(field, styleOrMap) : this.appendTextFieldMap(field, styleOrMap);
        }}, {key:"appendTextField", value:function(field) {
          return this.appendTextFieldStyle(field, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.FULL);
        }}, {key:"appendTextFieldStyle", value:function(field, textStyle) {
          ...
          return this;
        }}, {key:"appendTextFieldMap", value:function(field, textLookup) {
          requireNonNull(field, "field");
          requireInstance(field, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField, "field");
          requireNonNull(textLookup, "textLookup");
          textLookup = Object.assign({}, textLookup);
          var map = {};
          map[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.FULL] = textLookup;
          var store = new _LocaleStore__WEBPACK_IMPORTED_MODULE_4__.LocaleStore(map);
          this._appendInternal(new _parser_TextPrinterParser__WEBPACK_IMPORTED_MODULE_1__["default"](field, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.FULL, {getText:function(field, value, style) {
            return store.getText(value, style);
          }, getTextIterator:function(field, style) {
            return store.getTextIterator(style);
          }}));
          return this;
        }}, {key:"appendWeekField", value:function(field, count) {
          requireNonNull(field, "field");
    ...
    }, "./src/format/cldr/CldrDateTimeTextProvider.js":function(module, __webpack_exports__, __webpack_require__) {
      function _defineProperties(target, props) {
        for (var i = 0; i < props.length; i++) {
          var descriptor = props[i];
          descriptor.enumerable = descriptor.enumerable || !1;
      ...
      var _js_joda_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("@js-joda/core");
      __webpack_require__.n(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__);
      module = __webpack_require__("./utils/load_cldrData.prebuilt.js");
      var cldr_data__WEBPACK_IMPORTED_MODULE_1___default = __webpack_require__.n(module);
      module = __webpack_require__("./node_modules/cldrjs/dist/node_main.js");
      var cldrjs__WEBPACK_IMPORTED_MODULE_2___default = __webpack_require__.n(module), _LocaleStore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("./src/format/LocaleStore.js"), CldrDateTimeTextProvider = function() {
        function CldrDateTimeTextProvider() {
          if (!(this instanceof CldrDateTimeTextProvider)) {
            throw new TypeError("Cannot call a class as a function");
          }
          this._cache = {};
        ...
        _createClass(CldrDateTimeTextProvider, [{key:"getAvailableLocales", value:function() {
          return ["en", "en-US"];
        }}, {key:"getText", value:function(field, value, style, locale) {
          field = this._findStore(field, locale);
          return field instanceof _LocaleStore__WEBPACK_IMPORTED_MODULE_3__.LocaleStore ? field.getText(value, style) : null;
        }}, {key:"getTextIterator", value:function(field, style, locale) {
          field = this._findStore(field, locale);
          return field instanceof _LocaleStore__WEBPACK_IMPORTED_MODULE_3__.LocaleStore ? field.getTextIterator(style) : null;
        }}, {key:"_findStore", value:function(field, locale) {
          var key = Object(_LocaleStore__WEBPACK_IMPORTED_MODULE_3__.createEntry)(field, locale), store = this._cache[key];
          store === void 0 && (store = this._createStore(field, locale), this._cache[key] = store);
          return store;
        }}, {key:"_createStore", value:function(field, locale) {
          ...
          locale = new cldrjs__WEBPACK_IMPORTED_MODULE_2___default.a(locale.localeString());
          if (field === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.MONTH_OF_YEAR) {
            field = locale.main("dates/calendars/gregorian/months/format");
            locale = {};
            var data = {};
            data[1] = field.wide[1];
            data[2] = field.wide[2];
            ...
            data[8] = field.wide[8];
            data[9] = field.wide[9];
            data[10] = field.wide[10];
            data[11] = field.wide[11];
            data[12] = field.wide[12];
            locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.FULL] = data;
            data = {};
            data[1] = field.narrow[1];
            data[2] = field.narrow[2];
            data[3] = field.narrow[3];
            data[4] = field.narrow[4];
            data[5] = field.narrow[5];
            data[6] = field.narrow[6];
            data[7] = field.narrow[7];
            data[8] = field.narrow[8];
            data[9] = field.narrow[9];
            data[10] = field.narrow[10];
            data[11] = field.narrow[11];
            data[12] = field.narrow[12];
            locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.NARROW] = data;
            data = {};
            data[1] = field.abbreviated[1];
            data[2] = field.abbreviated[2];
            data[3] = field.abbreviated[3];
            data[4] = field.abbreviated[4];
            data[5] = field.abbreviated[5];
            data[6] = field.abbreviated[6];
            data[7] = field.abbreviated[7];
            data[8] = field.abbreviated[8];
            data[9] = field.abbreviated[9];
            data[10] = field.abbreviated[10];
            data[11] = field.abbreviated[11];
            data[12] = field.abbreviated[12];
            locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.SHORT] = data;
            return this._createLocaleStore(locale);
          }
          return field === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_WEEK ? (field = locale.main("dates/calendars/gregorian/days/format"), locale = {}, data = {}, data[1] = field.wide.mon, data[2] = field.wide.tue, data[3] = field.wide.wed, data[4] = field.wide.thu, data[5] = field.wide.fri, data[6] = field.wide.sat, data[7] = field.wide.sun, locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.FULL] = data, data = {}, data[1] = field.narrow.mon, data[2] = field.narrow.tue, 
          data[3] = field.narrow.wed, data[4] = field.narrow.thu, data[5] = field.narrow.fri, data[6] = field.narrow.sat, data[7] = field.narrow.sun, locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.NARROW] = data, data = {}, data[1] = field.abbreviated.mon, data[2] = field.abbreviated.tue, data[3] = field.abbreviated.wed, data[4] = field.abbreviated.thu, data[5] = field.abbreviated.fri, data[6] = field.abbreviated.sat, data[7] = field.abbreviated.sun, locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.SHORT] = 
          data, this._createLocaleStore(locale)) : field === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.AMPM_OF_DAY ? (field = locale.main("dates/calendars/gregorian/dayPeriods/format"), locale = {}, data = {}, data[0] = field.wide.am, data[1] = field.wide.pm, locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.FULL] = data, data = {}, data[0] = field.narrow.am, data[1] = field.narrow.pm, locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.NARROW] = data, data = {}, data[0] = 
          field.abbreviated.am, data[1] = field.abbreviated.pm, locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.SHORT] = data, this._createLocaleStore(locale)) : field === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.ERA ? (field = locale.main("dates/calendars/gregorian/eras"), locale = {}, data = {}, data[0] = field.eraNames["0"], data[1] = field.eraNames["1"], locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.FULL] = data, data = {}, data[0] = field.eraNarrow["0"], 
          data[1] = field.eraNarrow["1"], locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.NARROW] = data, data = {}, data[0] = field.eraAbbr["0"], data[1] = field.eraAbbr["1"], locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.SHORT] = data, this._createLocaleStore(locale)) : field === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.IsoFields.QUARTER_OF_YEAR ? (field = locale.main("dates/calendars/gregorian/quarters/format"), locale = {}, data = {}, data[1] = field.wide["1"], data[2] = 
          field.wide["2"], data[3] = field.wide["3"], data[4] = field.wide["4"], locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.FULL] = data, data = {}, data[1] = field.narrow["1"], data[2] = field.narrow["2"], data[3] = field.narrow["3"], data[4] = field.narrow["4"], locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.NARROW] = data, data = {}, data[1] = field.abbreviated["1"], data[2] = field.abbreviated["2"], data[3] = field.abbreviated["3"], data[4] = field.abbreviated["4"], 
          locale[_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.SHORT] = data, this._createLocaleStore(locale)) : null;
        }}, {key:"_createLocaleStore", value:function(valueTextMap) {
      ...
      module = __webpack_require__("./utils/load_cldrData.prebuilt.js");
      var cldr_data__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(module);
      module = __webpack_require__("./node_modules/cldrjs/dist/node_main.js");
      var cldrjs__WEBPACK_IMPORTED_MODULE_1___default = __webpack_require__.n(module), _js_joda_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("@js-joda/core");
      __webpack_require__.n(_js_joda_core__WEBPACK_IMPORTED_MODULE_2__);
      __webpack_require__ = _js_joda_core__WEBPACK_IMPORTED_MODULE_2__._.assert;
      var requireNonNull = __webpack_require__.requireNonNull, requireInstance = __webpack_require__.requireInstance, LENGTH_COMPARATOR = function(str1, str2) {
        var cmp = str2.length - str1.length;
        cmp === 0 && (cmp = str1.localeCompare(str2));
        return cmp;
      }, CldrZoneTextPrinterParser = function() {
        function CldrZoneTextPrinterParser(textStyle) {
          if (!(this instanceof CldrZoneTextPrinterParser)) {
            throw new TypeError("Cannot call a class as a function");
          }
          requireNonNull(textStyle, "textStyle");
        ...
        _createClass(CldrZoneTextPrinterParser, [{key:"_resolveZoneIdText", value:function(cldr, zoneId, style, type, mapZones) {
          var zoneData = cldr.main("dates/timeZoneNames/zone/".concat(zoneId, "/").concat(style, "/").concat(type));
          if (zoneData) {
            return zoneData;
          }
          if (zoneData = cldr.get("supplemental/metaZones/metazoneInfo/timezone/".concat(zoneId))) {
            zoneData = zoneData[zoneData.length - 1].usesMetazone._mzone;
            var metaZoneData = cldr.main("dates/timeZoneNames/metazone/".concat(zoneData, "/").concat(style, "/").concat(type));
            if (metaZoneData) {
              return metaZoneData;
            }
            (metaZoneData = cldr.main("dates/timeZoneNames/metazone/".concat(zoneData, "/").concat(style, "/generic"))) || (metaZoneData = cldr.main("dates/timeZoneNames/metazone/".concat(zoneData, "/").concat(style, "/standard")));
            if (metaZoneData) {
              return metaZoneData;
            }
            if (metaZoneData = mapZones[zoneData][cldr.attributes.territory]) {
              if (metaZoneData !== zoneId) {
                return this._resolveZoneIdText(cldr, metaZoneData, style, type, mapZones);
              }
            } else {
              if (zoneData = mapZones[zoneData]["001"], zoneData !== zoneId) {
                return this._resolveZoneIdText(cldr, zoneData, style, type, mapZones);
              }
            }
          }
        }}, {key:"print", value:function(context, buf) {
          ...
          context = new cldrjs__WEBPACK_IMPORTED_MODULE_1___default.a(context.locale().localeString());
          var mapZones = {};
          context.get("supplemental/metaZones/metazones").forEach(function(metaZone) {
            metaZone.mapZone && (mapZones[metaZone.mapZone._other] || (mapZones[metaZone.mapZone._other] = {}), mapZones[metaZone.mapZone._other][metaZone.mapZone._territory] = metaZone.mapZone._type);
          });
          (tzstyle = this._resolveZoneIdText(context, zone.id(), tzstyle, "generic", mapZones)) ? buf.append(tzstyle) : buf.append(zone.id());
          return !0;
        }}, {key:"parse", value:function(context, text, position) {
          var ids = {};
          cldrjs__WEBPACK_IMPORTED_MODULE_1___default.a.load(cldr_data__WEBPACK_IMPORTED_MODULE_0___default()("main/".concat(context.locale().localeString(), "/timeZoneNames.json")));
          var cldr = new cldrjs__WEBPACK_IMPORTED_MODULE_1___default.a(context.locale().localeString()), mapZones = {};
          cldr.get("supplemental/metaZones/metazones").forEach(function(metaZone) {
            metaZone.mapZone && (mapZones[metaZone.mapZone._other] || (mapZones[metaZone.mapZone._other] = {}), mapZones[metaZone.mapZone._other][metaZone.mapZone._territory] = metaZone.mapZone._type);
          });
          var _iteratorNormalCompletion = !0, _didIteratorError = !1, _iteratorError = void 0;
          try {
            for (var _iterator = _js_joda_core__WEBPACK_IMPORTED_MODULE_2__.ZoneRulesProvider.getAvailableZoneIds()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = !0) {
              var id = _step.value;
              ids[id] = id;
              var tzstyle = this._textStyle.asNormal() === _js_joda_core__WEBPACK_IMPORTED_MODULE_2__.TextStyle.FULL ? "long" : "short", genericText = this._resolveZoneIdText(cldr, id, tzstyle, "generic", mapZones);
              genericText && (ids[genericText] = id);
              var standardText = this._resolveZoneIdText(cldr, id, tzstyle, "standard", mapZones);
              standardText && (ids[standardText] = id);
              var daylightText = this._resolveZoneIdText(cldr, id, tzstyle, "daylight", mapZones);
              daylightText && (ids[daylightText] = id);
            }
          } catch (err) {
          ...
          cldr = Object.keys(ids).sort(LENGTH_COMPARATOR);
          _iteratorNormalCompletion = !0;
          _didIteratorError = !1;
          _iteratorError = void 0;
          try {
            for (var _iterator2 = cldr[Symbol.iterator](), _step2; !(_iteratorNormalCompletion = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion = !0) {
              var name = _step2.value;
              if (context.subSequenceEquals(text, position, name, 0, name.length)) {
                return context.setParsedZone(_js_joda_core__WEBPACK_IMPORTED_MODULE_2__.ZoneId.of(ids[name])), position + name.length;
              }
            }
          } catch (err) {
            _didIteratorError = !0, _iteratorError = err;
    ...
    }, "./src/format/parser/LocalizedOffsetPrinterParser.js":function(module, __webpack_exports__, __webpack_require__) {
      function _defineProperties(target, props) {
        for (var i = 0; i < props.length; i++) {
          var descriptor = props[i];
          descriptor.enumerable = descriptor.enumerable || !1;
      ...
      var _js_joda_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("@js-joda/core");
      __webpack_require__.n(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__);
      var MathUtil = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__._.MathUtil, LocalizedOffsetPrinterParser = function() {
        function LocalizedOffsetPrinterParser(textStyle) {
          if (!(this instanceof LocalizedOffsetPrinterParser)) {
            throw new TypeError("Cannot call a class as a function");
          }
          this._textStyle = textStyle;
        }
        _createClass(LocalizedOffsetPrinterParser, [{key:"textStyle", value:function() {
          ...
          context = MathUtil.safeToInt(offsetSecs);
          if (context !== 0) {
            offsetSecs = Math.abs(MathUtil.intMod(MathUtil.intDiv(context, 3600), 100));
            var absMinutes = Math.abs(MathUtil.intMod(MathUtil.intDiv(context, 60), 60)), absSeconds = Math.abs(MathUtil.intMod(context, 60));
            buf.append(context < 0 ? "-" : "+").append(offsetSecs);
            if (absMinutes > 0 || absSeconds > 0) {
              buf.append(":").append(MathUtil.intDiv(absMinutes, 10)).append(MathUtil.intMod(absMinutes, 10)), absSeconds > 0 && buf.append(":").append(MathUtil.intDiv(absSeconds, 10)).append(MathUtil.intMod(absSeconds, 10));
            }
          }
          return !0;
        }}, {key:"parse", value:function(context, text, position) {
          if (context.subSequenceEquals(text, position, "GMT", 0, 3) === !1) {
            return ~position;
          }
          position += 3;
          if (this._textStyle === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.FULL) {
          ...
          if (position !== end && (ch = text.charAt(position), ch >= "0" && ch <= "9")) {
          ...
          if (position === end || text.charAt(position) !== ":") {
            return context.setParsedField(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.OFFSET_SECONDS, sign * 3600 * hour, position, position);
          }
          position++;
          if (position > end - 2) {
            return ~position;
          ...
          if (position === end || text.charAt(position) !== ":") {
            return context.setParsedField(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.OFFSET_SECONDS, sign * (3600 * hour + 60 * min), position, position);
          }
          position++;
          if (position > end - 2) {
            return ~position;
          ...
          position++;
          end = MathUtil.parseInt(ch);
          ch = text.charAt(position);
          if (ch < "0" || ch > "9") {
            return ~position;
          }
          position++;
          end = end * 10 + MathUtil.parseInt(ch);
          return end > 59 ? ~position : context.setParsedField(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.OFFSET_SECONDS, sign * (3600 * hour + 60 * min + end), position, position);
        }}, {key:"toString", value:function() {
          return "LocalizedOffset(".concat(this._textStyle, ")");
        }}]);
        return LocalizedOffsetPrinterParser;
      }();
    }, "./src/format/parser/TextPrinterParser.js":function(module, __webpack_exports__, __webpack_require__) {
      function _defineProperties(target, props) {
        for (var i = 0; i < props.length; i++) {
          var descriptor = props[i];
          descriptor.enumerable = descriptor.enumerable || !1;
      ...
      var TextPrinterParser = function() {
        function TextPrinterParser(field, textStyle, provider) {
          if (!(this instanceof TextPrinterParser)) {
            throw new TypeError("Cannot call a class as a function");
          }
          this._field = field;
          this._textStyle = textStyle;
        ...
        _createClass(TextPrinterParser, [{key:"field", value:function() {
          return this._field;
        }}, {key:"textStyle", value:function() {
          return this._textStyle;
        }}, {key:"provider", value:function() {
          ...
          value = this._provider.getText(this._field, value, this._textStyle, context.locale());
          if (value === null) {
            return this._numberPrinterParser().print(context, buf);
          }
          buf.append(value);
          return !0;
        }}, {key:"parse", value:function(context, parseText, position) {
          ...
          length = context.isStrict() ? this._textStyle : null;
          length = this._provider.getTextIterator(this._field, length, context.locale());
          if (length != null) {
            var _iteratorNormalCompletion = !0, _didIteratorError = !1, _iteratorError = void 0;
            try {
              for (var _iterator = length[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = !0) {
                var entry = _step.value, itText = entry.key;
        ...
        }}, {key:"_numberPrinterParser", value:function() {
          this._currentNumberPrinterParser == null && (this._currentNumberPrinterParser = new _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.DateTimeFormatterBuilder.NumberPrinterParser(this._field, 1, 19, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.SignStyle.NORMAL));
          return this._currentNumberPrinterParser;
        }}, {key:"toString", value:function() {
          return this._textStyle === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.TextStyle.FULL ? "Text(".concat(this._field, ")") : "Text(".concat(this._field, ",").concat(this._textStyle, ")");
        }}]);
        return TextPrinterParser;
      }();
    }, "./src/format/parser/WeekFieldsPrinterParser.js":function(module, __webpack_exports__, __webpack_require__) {
      function _defineProperties(target, props) {
        for (var i = 0; i < props.length; i++) {
          var descriptor = props[i];
          descriptor.enumerable = descriptor.enumerable || !1;
      ...
      var _js_joda_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("@js-joda/core");
      __webpack_require__.n(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__);
      var _temporal_WeekFields__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/temporal/WeekFields.js"), StringBuilder = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__._.StringBuilder, WeekFieldsPrinterParser = function() {
        function WeekFieldsPrinterParser(letter, count) {
          if (!(this instanceof WeekFieldsPrinterParser)) {
            throw new TypeError("Cannot call a class as a function");
          }
          this._letter = letter;
          this._count = count;
        }
        _createClass(WeekFieldsPrinterParser, [{key:"print", value:function(context, buf) {
          var weekFields = _temporal_WeekFields__WEBPACK_IMPORTED_MODULE_1__.WeekFields.of(context.locale());
          return this._evaluate(weekFields).print(context, buf);
        }}, {key:"parse", value:function(context, text, position) {
          var weekFields = _temporal_WeekFields__WEBPACK_IMPORTED_MODULE_1__.WeekFields.of(context.locale());
          return this._evaluate(weekFields).parse(context, text, position);
        }}, {key:"_evaluate", value:function(weekFields) {
          var pp = null;
          switch(this._letter) {
            case "e":
            ...
            case "W":
              ...
              break;
            case "Y":
              pp = this._count === 2 ? new _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.DateTimeFormatterBuilder.ReducedPrinterParser(weekFields.weekBasedYear(), 2, 2, 0, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.DateTimeFormatterBuilder.ReducedPrinterParser.BASE_DATE) : new _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.DateTimeFormatterBuilder.NumberPrinterParser(weekFields.weekBasedYear(), this._count, 19, this._count < 4 ? _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.SignStyle.NORMAL : _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.SignStyle.EXCEEDS_PAD, 
              -1);
          }
          return pp;
        }}, {key:"toString", value:function() {
          ...
          sb.append("Localized(");
          this._letter === "Y" ? this._count === 1 ? sb.append("WeekBasedYear") : this._count === 2 ? sb.append("ReducedValue(WeekBasedYear,2,2,2000-01-01)") : sb.append("WeekBasedYear,").append(this._count).append(",").append(19).append(",").append(this._count < 4 ? _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.SignStyle.NORMAL : _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.SignStyle.EXCEEDS_PAD) : (this._letter === "c" || this._letter === "e" ? sb.append("DayOfWeek") : this._letter === "w" ? sb.append("WeekOfWeekBasedYear") : 
          this._letter === "W" && sb.append("WeekOfMonth"), sb.append(","), sb.append(this._count));
          sb.append(")");
          return sb.toString();
        }}]);
        return WeekFieldsPrinterParser;
      }();
    }, "./src/js-joda-locale.js":function(module, __webpack_exports__, __webpack_require__) {
      __webpack_require__.r(__webpack_exports__);
      module = __webpack_require__("@js-joda/core");
      __webpack_require__.n(module);
      var _plug__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/plug.js"), _Locale__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./src/Locale.js");
      __webpack_require__.d(__webpack_exports__, "Locale", function() {
        return _Locale__WEBPACK_IMPORTED_MODULE_2__["default"];
      });
      Object(module.use)(_plug__WEBPACK_IMPORTED_MODULE_1__["default"]);
    }, "./src/plug.js":function(module, __webpack_exports__, __webpack_require__) {
      __webpack_require__.r(__webpack_exports__);
      var _format_cldr_CldrDateTimeFormatterBuilder__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("./src/format/cldr/CldrDateTimeFormatterBuilder.js"), _format_LocaleDateTimeFormatter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("./src/format/LocaleDateTimeFormatter.js");
      __webpack_require__("./src/_init.js");
      __webpack_exports__["default"] = function(jsJoda) {
        Object.getOwnPropertyNames(_format_cldr_CldrDateTimeFormatterBuilder__WEBPACK_IMPORTED_MODULE_0__["default"].prototype).forEach(function(prop) {
          prop !== "constructor" && (jsJoda.DateTimeFormatterBuilder.prototype[prop] = _format_cldr_CldrDateTimeFormatterBuilder__WEBPACK_IMPORTED_MODULE_0__["default"].prototype[prop]);
        });
        Object.getOwnPropertyNames(_format_LocaleDateTimeFormatter__WEBPACK_IMPORTED_MODULE_1__["default"].prototype).forEach(function(prop) {
          prop !== "constructor" && (jsJoda.DateTimeFormatter.prototype[prop] = _format_LocaleDateTimeFormatter__WEBPACK_IMPORTED_MODULE_1__["default"].prototype[prop]);
        });
      };
    }, "./src/temporal/WeekFields.js":function(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.r(__webpack_exports__);
      __webpack_require__.d(__webpack_exports__, "ComputedDayOfField", function() {
        return ComputedDayOfField;
      });
      __webpack_require__.d(__webpack_exports__, "WeekFields", function() {
        return WeekFields;
      });
      __webpack_require__.d(__webpack_exports__, "_init", function() {
        return _init;
      ...
      ComputedDayOfField = function() {
        ...
        _createClass(ComputedDayOfField, null, [{key:"ofDayOfWeekField", value:function(weekDef) {
        ...
        }}, {key:"ofWeekOfMonthField", value:function(weekDef) {
        ...
        }}, {key:"ofWeekOfYearField", value:function(weekDef) {
        ...
        }}, {key:"ofWeekOfWeekBasedYearField", value:function(weekDef) {
        ...
        }}, {key:"ofWeekBasedYearField", value:function(weekDef) {
        ...
        _createClass(ComputedDayOfField, [{key:"getFrom", value:function(temporal) {
          var sow = this._weekDef.firstDayOfWeek().value();
          sow = this._localizedDayOfWeek(temporal, sow);
          ...
          if (this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.MONTHS) {
            return this._localizedWeekOfMonth(temporal, sow);
          }
          if (this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.YEARS) {
            return this._localizedWeekOfYear(temporal, sow);
          }
          if (this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.IsoFields.WEEK_BASED_YEARS) {
        ...
        }}, {key:"_localizedDayOfWeek", value:function(temporal, sow) {
          temporal = temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_WEEK);
          return MathUtil.floorMod(temporal - sow, 7) + 1;
        }}, {key:"_localizedWeekOfMonth", value:function(temporal, dow) {
          temporal = temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_MONTH);
          dow = this._startOfWeekOffset(temporal, dow);
          return ComputedDayOfField._computeWeek(dow, temporal);
        }}, {key:"_localizedWeekOfYear", value:function(temporal, dow) {
          temporal = temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_YEAR);
          dow = this._startOfWeekOffset(temporal, dow);
          return ComputedDayOfField._computeWeek(dow, temporal);
        }}, {key:"_localizedWOWBY", value:function(temporal) {
          var sow = this._weekDef.firstDayOfWeek().value(), isoDow = temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_WEEK);
          isoDow = MathUtil.floorMod(isoDow - sow, 7) + 1;
          sow = this._localizedWeekOfYear(temporal, isoDow);
          return sow === 0 ? (sow = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.LocalDate.from(temporal).minus(1, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.WEEKS), this._localizedWeekOfYear(sow, isoDow) + 1) : sow >= 53 && (isoDow = this._startOfWeekOffset(temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_YEAR), isoDow), temporal = temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.YEAR), temporal = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.Year.isLeap(temporal) ? 
          366 : 365, temporal = ComputedDayOfField._computeWeek(isoDow, temporal + this._weekDef.minimalDaysInFirstWeek()), sow >= temporal) ? sow - (temporal - 1) : sow;
        }}, {key:"_localizedWBY", value:function(temporal) {
          var sow = this._weekDef.firstDayOfWeek().value(), isoDow = temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_WEEK), dow = MathUtil.floorMod(isoDow - sow, 7) + 1;
          sow = temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.YEAR);
          isoDow = this._localizedWeekOfYear(temporal, dow);
          if (isoDow === 0) {
            return sow - 1;
          }
          if (isoDow < 53) {
          ...
          temporal = this._startOfWeekOffset(temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_YEAR), dow);
          dow = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.Year.isLeap(sow) ? 366 : 365;
          temporal = ComputedDayOfField._computeWeek(temporal, dow + this._weekDef.minimalDaysInFirstWeek());
          return isoDow >= temporal ? sow + 1 : sow;
        }}, {key:"_startOfWeekOffset", value:function(day, dow) {
          day = MathUtil.floorMod(day - dow, 7);
          dow = -day;
          day + 1 > this._weekDef.minimalDaysInFirstWeek() && (dow = 7 - day);
          return dow;
        }}, {key:"adjustInto", value:function(temporal, newValue) {
          var newVal = this._range.checkValidIntValue(newValue, this), currentVal = temporal.get(this);
          if (newVal === currentVal) {
            return temporal;
          }
          if (this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.FOREVER) {
            var baseWowby = temporal.get(this._weekDef.weekOfWeekBasedYear());
            newValue = MathUtil.roundDown((newValue - currentVal) * 52.1775);
            temporal = temporal.plus(newValue, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.WEEKS);
            temporal.get(this) > newVal ? (newVal = temporal.get(this._weekDef.weekOfWeekBasedYear()), temporal = temporal.minus(newVal, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.WEEKS)) : (temporal.get(this) < newVal && (temporal = temporal.plus(2, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.WEEKS)), newValue = temporal.get(this._weekDef.weekOfWeekBasedYear()), temporal = temporal.plus(baseWowby - newValue, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.WEEKS), temporal.get(this) > 
            newVal && (temporal = temporal.minus(1, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.WEEKS)));
            return temporal;
          }
          return temporal.plus(newVal - currentVal, this._baseUnit);
        }}, {key:"resolve", value:function(fieldValues, partialTemporal, resolverStyle) {
          partialTemporal = this._weekDef.firstDayOfWeek().value();
          if (this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.WEEKS) {
            return resolverStyle = fieldValues.remove(this), resolverStyle = this._range.checkValidIntValue(resolverStyle, this), resolverStyle = MathUtil.floorMod(partialTemporal - 1 + (resolverStyle - 1), 7) + 1, fieldValues.put(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_WEEK, resolverStyle), null;
          }
          if (fieldValues.containsKey(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_WEEK) === !1) {
            return null;
          }
          if (this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.FOREVER) {
            if (fieldValues.containsKey(this._weekDef.weekOfWeekBasedYear()) === !1) {
              return null;
            }
            ...
            _isoDow2 = MathUtil.floorMod(_isoDow2 - partialTemporal, 7) + 1;
            ...
            if (resolverStyle === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ResolverStyle.LENIENT) {
              wby = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.LocalDate.of(wby, 1, this._weekDef.minimalDaysInFirstWeek());
              var wowby = fieldValues.get(this._weekDef.weekOfWeekBasedYear());
              partialTemporal = this._localizedDayOfWeek(wby, partialTemporal);
              partialTemporal = (wowby - this._localizedWeekOfYear(wby, partialTemporal)) * 7 + (_isoDow2 - partialTemporal);
            } else {
              wby = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.LocalDate.of(wby, 1, this._weekDef.minimalDaysInFirstWeek()), wowby = this._weekDef.weekOfWeekBasedYear().range().checkValidIntValue(fieldValues.get(this._weekDef.weekOfWeekBasedYear()), this._weekDef.weekOfWeekBasedYear), partialTemporal = this._localizedDayOfWeek(wby, partialTemporal), partialTemporal = (wowby - this._localizedWeekOfYear(wby, partialTemporal)) * 7 + (_isoDow2 - partialTemporal);
            }
            wby = wby.plus(partialTemporal, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.DAYS);
            if (resolverStyle === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ResolverStyle.STRICT && wby.getLong(this) !== fieldValues.get(this)) {
          ...
          if (fieldValues.containsKey(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.YEAR) === !1) {
            return null;
          }
          _isoDow2 = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_WEEK.checkValidIntValue(fieldValues.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_WEEK));
          _isoDow2 = MathUtil.floorMod(_isoDow2 - partialTemporal, 7) + 1;
          wowby = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.YEAR.checkValidIntValue(fieldValues.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.YEAR));
          if (this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.MONTHS) {
            if (fieldValues.containsKey(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.MONTH_OF_YEAR) === !1) {
              return null;
            }
            ...
            if (resolverStyle === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ResolverStyle.LENIENT) {
              ...
              wowby = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.LocalDate.of(wowby, 1, 1);
              wowby = wowby.plus(month - 1, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.MONTHS);
              partialTemporal = this._localizedDayOfWeek(wowby, partialTemporal);
              partialTemporal = (wby - this._localizedWeekOfMonth(wowby, partialTemporal)) * 7 + (_isoDow2 - partialTemporal);
            } else {
              month = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.MONTH_OF_YEAR.checkValidIntValue(fieldValues.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.MONTH_OF_YEAR)), wowby = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.LocalDate.of(wowby, month, 8), partialTemporal = this._localizedDayOfWeek(wowby, partialTemporal), partialTemporal = (this._range.checkValidIntValue(wby, this) - this._localizedWeekOfMonth(wowby, partialTemporal)) * 7 + (_isoDow2 - partialTemporal);
            }
            wowby = wowby.plus(partialTemporal, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.DAYS);
            if (resolverStyle === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ResolverStyle.STRICT && wowby.getLong(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.MONTH_OF_YEAR) !== fieldValues.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.MONTH_OF_YEAR)) {
          ...
          if (this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.YEARS) {
            wby = fieldValues.remove(this);
            wowby = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.LocalDate.of(wowby, 1, 1);
            resolverStyle === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ResolverStyle.LENIENT ? (partialTemporal = this._localizedDayOfWeek(wowby, partialTemporal), partialTemporal = (wby - this._localizedWeekOfYear(wowby, partialTemporal)) * 7 + (_isoDow2 - partialTemporal)) : (partialTemporal = this._localizedDayOfWeek(wowby, partialTemporal), partialTemporal = (this._range.checkValidIntValue(wby, this) - this._localizedWeekOfYear(wowby, partialTemporal)) * 7 + (_isoDow2 - partialTemporal));
            wowby = wowby.plus(partialTemporal, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.DAYS);
            if (resolverStyle === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ResolverStyle.STRICT && wowby.getLong(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.YEAR) !== fieldValues.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.YEAR)) {
              throw new _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.DateTimeException("Strict mode rejected date parsed to a different year");
            }
            fieldValues.remove(this);
            fieldValues.remove(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.YEAR);
          ...
          return this._name;
        }}, {key:"baseUnit", value:function() {
          return this._baseUnit;
        }}, {key:"rangeUnit", value:function() {
          return this._rangeUnit;
        }}, {key:"range", value:function() {
          return this._range;
        }}, {key:"isDateBased", value:function() {
          return !0;
        }}, {key:"isTimeBased", value:function() {
          return !1;
        }}, {key:"isSupportedBy", value:function(temporal) {
          if (temporal.isSupported(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_WEEK)) {
            ...
            if (this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.IsoFields.WEEK_BASED_YEARS || this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.FOREVER) {
              return temporal.isSupported(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.EPOCH_DAY);
            }
          }
          return !1;
        }}, {key:"rangeRefinedBy", value:function(temporal) {
          if (this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.WEEKS) {
            return this._range;
          }
          if (this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.MONTHS) {
            var field = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_MONTH;
          ...
          var sow = this._weekDef.firstDayOfWeek().value(), isoDow = temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_WEEK);
          sow = MathUtil.floorMod(isoDow - sow, 7) + 1;
          sow = this._startOfWeekOffset(temporal.get(field), sow);
          temporal = temporal.range(field);
          return _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ValueRange.of(ComputedDayOfField._computeWeek(sow, temporal.minimum()), ComputedDayOfField._computeWeek(sow, temporal.maximum()));
        }}, {key:"_rangeWOWBY", value:function(temporal) {
          var sow = this._weekDef.firstDayOfWeek().value(), isoDow = temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_WEEK);
          isoDow = MathUtil.floorMod(isoDow - sow, 7) + 1;
          sow = this._localizedWeekOfYear(temporal, isoDow);
          if (sow === 0) {
          ...
          isoDow = this._startOfWeekOffset(temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.DAY_OF_YEAR), isoDow);
          var year = temporal.get(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoField.YEAR);
          year = _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.Year.isLeap(year) ? 366 : 365;
          isoDow = ComputedDayOfField._computeWeek(isoDow, year + this._weekDef.minimalDaysInFirstWeek());
          return sow >= isoDow ? this._rangeWOWBY(_js_joda_core__WEBPACK_IMPORTED_MODULE_0__.IsoChronology.INSTANCE.date(temporal).plus(2, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.WEEKS)) : _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ValueRange.of(1, isoDow - 1);
        }}, {key:"getDisplayName", value:function(locale) {
          requireNonNull(locale, "locale");
          return this._rangeUnit === _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.ChronoUnit.YEARS ? "Week" : this.toString();
        }}, {key:"toString", value:function() {
          return this._name + "[" + this._weekDef.toString() + "]";
        }}], [{key:"_computeWeek", value:function(offset, day) {
          return MathUtil.intDiv(7 + offset + (day - 1), 7);
        }}]);
        return ComputedDayOfField;
      }(), WeekFieldsCache = new Map(), WeekFields = function() {
        ...
        _createClass(WeekFields, null, [{key:"of", value:function(firstDayOrLocale, minDays) {
          return minDays === void 0 ? WeekFields.ofLocale(firstDayOrLocale) : WeekFields.ofFirstDayOfWeekMinDays(firstDayOrLocale, minDays);
        }}, {key:"ofLocale", value:function(locale) {
          requireNonNull(locale, "locale");
          ...
          var weekData = (new cldrjs__WEBPACK_IMPORTED_MODULE_2___default.a(locale.localeString())).get("supplemental/weekData"), dow = _weekDayMap[weekData.firstDay[locale.country()]];
          dow ||= _weekDayMap[weekData.firstDay["001"]];
          (locale = weekData.minDays[locale.country()]) || (locale = weekData.minDays["001"]);
          return WeekFields.ofFirstDayOfWeekMinDays(dow, locale);
        }}, {key:"ofFirstDayOfWeekMinDays", value:function(firstDayOfWeek, minimalDaysInFirstWeek) {
          requireNonNull(firstDayOfWeek, "firstDayOfWeek");
          requireInstance(firstDayOfWeek, _js_joda_core__WEBPACK_IMPORTED_MODULE_0__.DayOfWeek, "firstDayOfWeek");
          requireNonNull(minimalDaysInFirstWeek, "minimalDaysInFirstWeek");
          var key = firstDayOfWeek.toString() + minimalDaysInFirstWeek, rules = WeekFieldsCache.get(key);
          rules == null && (rules = new WeekFields(firstDayOfWeek, minimalDaysInFirstWeek), WeekFieldsCache.set(key, rules), rules = WeekFieldsCache.get(key));
          return rules;
        }}]);
        _createClass(WeekFields, [{key:"firstDayOfWeek", value:function() {
          return this._firstDayOfWeek;
        }}, {key:"minimalDaysInFirstWeek", value:function() {
          return this._minimalDays;
        }}, {key:"dayOfWeek", value:function() {
          return this._dayOfWeek;
        }}, {key:"weekOfMonth", value:function() {
          return this._weekOfMonth;
        }}, {key:"weekOfYear", value:function() {
          return this._weekOfYear;
        }}, {key:"weekOfWeekBasedYear", value:function() {
          return this._weekOfWeekBasedYear;
        }}, {key:"weekBasedYear", value:function() {
          return this._weekBasedYear;
        }}, {key:"equals", value:function(other) {
          return this === other ? !0 : other instanceof WeekFields ? this.hashCode() === other.hashCode() : !1;
    ...
    }, "./utils/load_cldrData.prebuilt.js":function(module, exports, __webpack_require__) {
      module.exports = function(cldrPath) {
        return __webpack_require__("./node_modules/cldr-data sync recursive ^\\.\\/.*$")("./" + cldrPath);
      };
    }, "@js-joda/core":function(module, exports) {
