...
return cljs.core.reduce_kv(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__101145_SHARP_){
return malli.impl.util._map_invalid(cljs.core.reduced,p1__101145_SHARP_);
}),f),init,coll);
});
...
var G__101151 = arguments.length;
switch (G__101151) {
case 4:
...
var G__101154 = arguments.length;
switch (G__101154) {
case 1:
...
return (function (m){
return cljs.core.boolean$(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__101160_SHARP_,p2__101159_SHARP_){
var or__5025__auto__ = (p2__101159_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p2__101159_SHARP_.cljs$core$IFn$_invoke$arity$1(m) : p2__101159_SHARP_.call(null,m));
...
return (function (x){
return cljs.core.boolean$(cljs.core.some((function (p1__101161_SHARP_){
return (p1__101161_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__101161_SHARP_.cljs$core$IFn$_invoke$arity$1(x) : p1__101161_SHARP_.call(null,x));
}),preds));
});
});
