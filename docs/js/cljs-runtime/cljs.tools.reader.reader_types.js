...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_104268 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_104268(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_104269 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_104269(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_104271 = (function (reader,ch){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_104271(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_104272 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_104272(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_104273 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_104273(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_104275 = (function (reader){
var x__5373__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_104275(reader);
}
});
...
var G__104211 = arguments.length;
switch (G__104211) {
case 1:
...
var G__104219 = arguments.length;
switch (G__104219) {
case 1:
...
var G__104229 = arguments.length;
switch (G__104229) {
case 1:
...
var G__104316 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__104317 = s.append(c);
c = G__104316;
s = G__104317;
continue;
}
