...
var G__106435 = arguments.length;
switch (G__106435) {
case 1:
...
(uix.dom.create_root.cljs$core$IFn$_invoke$arity$2 = (function (node,p__106437){
var map__106438 = p__106437;
var map__106438__$1 = cljs.core.__destructure_map(map__106438);
var on_recoverable_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106438__$1,new cljs.core.Keyword(null,"on-recoverable-error","on-recoverable-error",1651056576));
var identifier_prefix = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106438__$1,new cljs.core.Keyword(null,"identifier-prefix","identifier-prefix",1929840008));
var on_caught_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106438__$1,new cljs.core.Keyword(null,"on-caught-error","on-caught-error",2071941198));
var on_uncaught_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106438__$1,new cljs.core.Keyword(null,"on-uncaught-error","on-uncaught-error",289860558));
...
var G__106440 = arguments.length;
switch (G__106440) {
case 2:
...
(uix.dom.hydrate_root.cljs$core$IFn$_invoke$arity$3 = (function (container,element,p__106441){
var map__106442 = p__106441;
var map__106442__$1 = cljs.core.__destructure_map(map__106442);
var options = map__106442__$1;
var on_recoverable_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106442__$1,new cljs.core.Keyword(null,"on-recoverable-error","on-recoverable-error",1651056576));
var identifier_prefix = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106442__$1,new cljs.core.Keyword(null,"identifier-prefix","identifier-prefix",1929840008));
...
var G__106449 = arguments.length;
switch (G__106449) {
case 2:
 ...
 */
uix.dom.preload = (function uix$dom$preload(url,p__106452){
var map__106453 = p__106452;
var map__106453__$1 = cljs.core.__destructure_map(map__106453);
var integrity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106453__$1,new cljs.core.Keyword(null,"integrity","integrity",-562947111));
var image_src_set = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106453__$1,new cljs.core.Keyword(null,"image-src-set","image-src-set",685363003));
var nonce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106453__$1,new cljs.core.Keyword(null,"nonce","nonce",564330331));
var as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106453__$1,new cljs.core.Keyword(null,"as","as",1148689641));
var fetch_priority = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106453__$1,new cljs.core.Keyword(null,"fetch-priority","fetch-priority",-678604566));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106453__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var referrer_policy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106453__$1,new cljs.core.Keyword(null,"referrer-policy","referrer-policy",-504499278));
var image_sizes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106453__$1,new cljs.core.Keyword(null,"image-sizes","image-sizes",-185365515));
var cross_origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106453__$1,new cljs.core.Keyword(null,"cross-origin","cross-origin",-2100195210));
 ...
 */
uix.dom.preload_module = (function uix$dom$preload_module(url,p__106456){
var map__106457 = p__106456;
var map__106457__$1 = cljs.core.__destructure_map(map__106457);
var as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106457__$1,new cljs.core.Keyword(null,"as","as",1148689641));
var cross_origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106457__$1,new cljs.core.Keyword(null,"cross-origin","cross-origin",-2100195210));
var integrity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106457__$1,new cljs.core.Keyword(null,"integrity","integrity",-562947111));
var nonce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106457__$1,new cljs.core.Keyword(null,"nonce","nonce",564330331));
 ...
 */
uix.dom.preinit = (function uix$dom$preinit(url,p__106459){
var map__106460 = p__106459;
var map__106460__$1 = cljs.core.__destructure_map(map__106460);
var as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106460__$1,new cljs.core.Keyword(null,"as","as",1148689641));
var precedence = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106460__$1,new cljs.core.Keyword(null,"precedence","precedence",-425651461));
var cross_origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106460__$1,new cljs.core.Keyword(null,"cross-origin","cross-origin",-2100195210));
var integrity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106460__$1,new cljs.core.Keyword(null,"integrity","integrity",-562947111));
var nonce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106460__$1,new cljs.core.Keyword(null,"nonce","nonce",564330331));
var fetch_priority = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106460__$1,new cljs.core.Keyword(null,"fetch-priority","fetch-priority",-678604566));
 ...
 */
uix.dom.preinit_module = (function uix$dom$preinit_module(url,p__106461){
var map__106462 = p__106461;
var map__106462__$1 = cljs.core.__destructure_map(map__106462);
var as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106462__$1,new cljs.core.Keyword(null,"as","as",1148689641));
var cross_origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106462__$1,new cljs.core.Keyword(null,"cross-origin","cross-origin",-2100195210));
var integrity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106462__$1,new cljs.core.Keyword(null,"integrity","integrity",-562947111));
var nonce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__106462__$1,new cljs.core.Keyword(null,"nonce","nonce",564330331));
