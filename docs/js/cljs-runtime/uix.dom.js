...
(uix.dom.create_root.cljs$core$IFn$_invoke$arity$2 = (function (node,p__79984){
var map__79985 = p__79984;
var map__79985__$1 = cljs.core.__destructure_map(map__79985);
var on_recoverable_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79985__$1,new cljs.core.Keyword(null,"on-recoverable-error","on-recoverable-error",1651056576));
var identifier_prefix = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79985__$1,new cljs.core.Keyword(null,"identifier-prefix","identifier-prefix",1929840008));
var on_caught_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79985__$1,new cljs.core.Keyword(null,"on-caught-error","on-caught-error",2071941198));
var on_uncaught_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79985__$1,new cljs.core.Keyword(null,"on-uncaught-error","on-uncaught-error",289860558));
...
(uix.dom.hydrate_root.cljs$core$IFn$_invoke$arity$3 = (function (container,element,p__79996){
var map__79997 = p__79996;
var map__79997__$1 = cljs.core.__destructure_map(map__79997);
var options = map__79997__$1;
var on_recoverable_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79997__$1,new cljs.core.Keyword(null,"on-recoverable-error","on-recoverable-error",1651056576));
var identifier_prefix = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__79997__$1,new cljs.core.Keyword(null,"identifier-prefix","identifier-prefix",1929840008));
 ...
 */
uix.dom.preload = (function uix$dom$preload(url,p__80036){
var map__80039 = p__80036;
var map__80039__$1 = cljs.core.__destructure_map(map__80039);
var integrity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80039__$1,new cljs.core.Keyword(null,"integrity","integrity",-562947111));
var image_src_set = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80039__$1,new cljs.core.Keyword(null,"image-src-set","image-src-set",685363003));
var nonce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80039__$1,new cljs.core.Keyword(null,"nonce","nonce",564330331));
var as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80039__$1,new cljs.core.Keyword(null,"as","as",1148689641));
var fetch_priority = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80039__$1,new cljs.core.Keyword(null,"fetch-priority","fetch-priority",-678604566));
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80039__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var referrer_policy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80039__$1,new cljs.core.Keyword(null,"referrer-policy","referrer-policy",-504499278));
var image_sizes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80039__$1,new cljs.core.Keyword(null,"image-sizes","image-sizes",-185365515));
var cross_origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80039__$1,new cljs.core.Keyword(null,"cross-origin","cross-origin",-2100195210));
 ...
 */
uix.dom.preload_module = (function uix$dom$preload_module(url,p__80045){
var map__80046 = p__80045;
var map__80046__$1 = cljs.core.__destructure_map(map__80046);
var as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80046__$1,new cljs.core.Keyword(null,"as","as",1148689641));
var cross_origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80046__$1,new cljs.core.Keyword(null,"cross-origin","cross-origin",-2100195210));
var integrity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80046__$1,new cljs.core.Keyword(null,"integrity","integrity",-562947111));
var nonce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80046__$1,new cljs.core.Keyword(null,"nonce","nonce",564330331));
 ...
 */
uix.dom.preinit = (function uix$dom$preinit(url,p__80050){
var map__80051 = p__80050;
var map__80051__$1 = cljs.core.__destructure_map(map__80051);
var as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80051__$1,new cljs.core.Keyword(null,"as","as",1148689641));
var precedence = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80051__$1,new cljs.core.Keyword(null,"precedence","precedence",-425651461));
var cross_origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80051__$1,new cljs.core.Keyword(null,"cross-origin","cross-origin",-2100195210));
var integrity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80051__$1,new cljs.core.Keyword(null,"integrity","integrity",-562947111));
var nonce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80051__$1,new cljs.core.Keyword(null,"nonce","nonce",564330331));
var fetch_priority = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80051__$1,new cljs.core.Keyword(null,"fetch-priority","fetch-priority",-678604566));
 ...
 */
uix.dom.preinit_module = (function uix$dom$preinit_module(url,p__80054){
var map__80055 = p__80054;
var map__80055__$1 = cljs.core.__destructure_map(map__80055);
var as = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80055__$1,new cljs.core.Keyword(null,"as","as",1148689641));
var cross_origin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80055__$1,new cljs.core.Keyword(null,"cross-origin","cross-origin",-2100195210));
var integrity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80055__$1,new cljs.core.Keyword(null,"integrity","integrity",-562947111));
var nonce = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80055__$1,new cljs.core.Keyword(null,"nonce","nonce",564330331));
