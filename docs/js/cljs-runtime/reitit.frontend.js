...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,(function (p1__104014_SHARP_){
return reitit.frontend.query_param(q,p1__104014_SHARP_);
})),q.getKeys()));
});
/**
...
var new_query = ((cljs.core.fn_QMARK_(new_query_or_update_fn))?(function (){var G__104026 = reitit.frontend.query_params(uri);
return (new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1 ? new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1(G__104026) : new_query_or_update_fn.call(null,G__104026));
...
var G__104030 = arguments.length;
switch (G__104030) {
case 1:
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__104037),"#",reitit.impl.form_encode(fragment)].join('');
} else {
return G__104037;
}
} else {
...
(reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$3 = (function (router,path,p__104052){
var map__104053 = p__104052;
var map__104053__$1 = cljs.core.__destructure_map(map__104053);
var on_coercion_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__104053__$1,new cljs.core.Keyword(null,"on-coercion-error","on-coercion-error",-970787));
var uri = goog.Uri.parse(path);
var coerce_BANG_ = (cljs.core.truth_(on_coercion_error)?(function (match){
try{return reitit.coercion.coerce_BANG_(match);
}catch (e104054){if((e104054 instanceof Error)){
var e = e104054;
...
var G__104059 = arguments.length;
switch (G__104059) {
case 2:
...
var G__104067 = arguments.length;
switch (G__104067) {
case 1:
...
if(cljs.core.every_QMARK_((function (p1__104068_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__104068_SHARP_);
