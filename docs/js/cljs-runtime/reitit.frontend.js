...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword,(function (p1__78674_SHARP_){
return reitit.frontend.query_param(q,p1__78674_SHARP_);
})),q.getKeys()));
});
/**
...
var new_query = ((cljs.core.fn_QMARK_(new_query_or_update_fn))?(function (){var G__78687 = reitit.frontend.query_params(uri);
return (new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1 ? new_query_or_update_fn.cljs$core$IFn$_invoke$arity$1(G__78687) : new_query_or_update_fn.call(null,G__78687));
...
var G__78723 = path;
if(cljs.core.truth_((function (){var and__5139__auto__ = fragment;
...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78723)+"#"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(reitit.impl.form_encode(fragment)));
} else {
return G__78723;
}
} else {
...
(reitit.frontend.match_by_path.cljs$core$IFn$_invoke$arity$3 = (function (router,path,p__78739){
var map__78742 = p__78739;
var map__78742__$1 = cljs.core.__destructure_map(map__78742);
var on_coercion_error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78742__$1,new cljs.core.Keyword(null,"on-coercion-error","on-coercion-error",-970787));
var uri = goog.Uri.parse(path);
var coerce_BANG_ = (cljs.core.truth_(on_coercion_error)?(function (match){
try{return reitit.coercion.coerce_BANG_(match);
}catch (e78755){if((e78755 instanceof Error)){
var e = e78755;
...
var parameters = (function (){var or__5141__auto__ = (coerce_BANG_.cljs$core$IFn$_invoke$arity$1 ? coerce_BANG_.cljs$core$IFn$_invoke$arity$1(match__$1) : coerce_BANG_.call(null,match__$1));
...
if(cljs.core.every_QMARK_((function (p1__78823_SHARP_){
return cljs.core.contains_QMARK_(path_params,p1__78823_SHARP_);
