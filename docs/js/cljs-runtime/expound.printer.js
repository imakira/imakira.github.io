...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__100833_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__100833_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__100839_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__100839_SHARP_)));
}),row));
});
...
var G__100847 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__100848 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__100847,G__100848) : expound.printer.format.call(null,G__100847,G__100848));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__100849_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__100849_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__100850_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__100850_SHARP_)).length),"="));
}),header);
...
var iter__5503__auto__ = (function expound$printer$multirow_$_iter__100863(s__100864){
return (new cljs.core.LazySeq(null,(function (){
var s__100864__$1 = s__100864;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__100864__$1);
if(temp__5823__auto__){
var s__100864__$2 = temp__5823__auto__;
if(cljs.core.chunked_seq_QMARK_(s__100864__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__100864__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__100866 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__100865 = (0);
while(true){
if((i__100865 < size__5502__auto__)){
var row_idx = cljs.core._nth(c__5501__auto__,i__100865);
cljs.core.chunk_append(b__100866,(function (){var iter__5503__auto__ = ((function (i__100865,row_idx,c__5501__auto__,size__5502__auto__,b__100866,s__100864__$2,temp__5823__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__100863_$_iter__100867(s__100868){
return (new cljs.core.LazySeq(null,((function (i__100865,row_idx,c__5501__auto__,size__5502__auto__,b__100866,s__100864__$2,temp__5823__auto__,split_row_contents){
return (function (){
var s__100868__$1 = s__100868;
while(true){
var temp__5823__auto____$1 = cljs.core.seq(s__100868__$1);
if(temp__5823__auto____$1){
var s__100868__$2 = temp__5823__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__100868__$2)){
var c__5501__auto____$1 = cljs.core.chunk_first(s__100868__$2);
var size__5502__auto____$1 = cljs.core.count(c__5501__auto____$1);
var b__100870 = cljs.core.chunk_buffer(size__5502__auto____$1);
if((function (){var i__100869 = (0);
while(true){
if((i__100869 < size__5502__auto____$1)){
var col_idx = cljs.core._nth(c__5501__auto____$1,i__100869);
cljs.core.chunk_append(b__100870,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__101177 = (i__100869 + (1));
i__100869 = G__101177;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__100870),expound$printer$multirow_$_iter__100863_$_iter__100867(cljs.core.chunk_rest(s__100868__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__100870),null);
}
} else {
var col_idx = cljs.core.first(s__100868__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__100863_$_iter__100867(cljs.core.rest(s__100868__$2)));
}
} else {
return null;
}
...
});})(i__100865,row_idx,c__5501__auto__,size__5502__auto__,b__100866,s__100864__$2,temp__5823__auto__,split_row_contents))
,null,null));
});})(i__100865,row_idx,c__5501__auto__,size__5502__auto__,b__100866,s__100864__$2,temp__5823__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__100866),expound$printer$multirow_$_iter__100863(cljs.core.chunk_rest(s__100864__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__100866),null);
}
} else {
var row_idx = cljs.core.first(s__100864__$2);
return cljs.core.cons((function (){var iter__5503__auto__ = ((function (row_idx,s__100864__$2,temp__5823__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__100863_$_iter__100871(s__100872){
return (new cljs.core.LazySeq(null,(function (){
var s__100872__$1 = s__100872;
while(true){
var temp__5823__auto____$1 = cljs.core.seq(s__100872__$1);
if(temp__5823__auto____$1){
var s__100872__$2 = temp__5823__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__100872__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__100872__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__100874 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__100873 = (0);
while(true){
if((i__100873 < size__5502__auto__)){
var col_idx = cljs.core._nth(c__5501__auto__,i__100873);
cljs.core.chunk_append(b__100874,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__101182 = (i__100873 + (1));
i__100873 = G__101182;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__100874),expound$printer$multirow_$_iter__100863_$_iter__100871(cljs.core.chunk_rest(s__100872__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__100874),null);
}
} else {
var col_idx = cljs.core.first(s__100872__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__100863_$_iter__100871(cljs.core.rest(s__100872__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__100864__$2,temp__5823__auto__,split_row_contents))
;
return iter__5503__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__100863(cljs.core.rest(s__100864__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__100881_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__100881_SHARP_,column_keys);
}),map_rows));
...
var G__100909 = arguments.length;
switch (G__100909) {
case 1:
...
var form = (function (){var G__100926 = via;
var G__100926__$1 = (((G__100926 == null))?null:cljs.core.last(G__100926));
if((G__100926__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__100926__$1);
}
})();
var keys_specs = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__100924_SHARP_){
return cljs.spec.alpha.valid_QMARK_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__100924_SHARP_);
...
}),cljs.core.tree_seq(cljs.core.coll_QMARK_,cljs.core.seq,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"clauses","clauses",1454841241),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__100925_SHARP_){
return cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__100925_SHARP_);
}),keys_specs)], 0))], 0))))));
}
});
expound.printer.key__GT_spec = (function expound$printer$key__GT_spec(keys,problems){
var seq__100943_101191 = cljs.core.seq(problems);
var chunk__100944_101192 = null;
var count__100945_101193 = (0);
var i__100946_101194 = (0);
while(true){
if((i__100946_101194 < count__100945_101193)){
var p_101195 = chunk__100944_101192.cljs$core$IIndexed$_nth$arity$2(null,i__100946_101194);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_101195) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__101196 = seq__100943_101191;
var G__101197 = chunk__100944_101192;
var G__101198 = count__100945_101193;
var G__101199 = (i__100946_101194 + (1));
seq__100943_101191 = G__101196;
chunk__100944_101192 = G__101197;
count__100945_101193 = G__101198;
i__100946_101194 = G__101199;
continue;
} else {
var temp__5823__auto___101200 = cljs.core.seq(seq__100943_101191);
if(temp__5823__auto___101200){
var seq__100943_101203__$1 = temp__5823__auto___101200;
if(cljs.core.chunked_seq_QMARK_(seq__100943_101203__$1)){
var c__5548__auto___101204 = cljs.core.chunk_first(seq__100943_101203__$1);
var G__101207 = cljs.core.chunk_rest(seq__100943_101203__$1);
var G__101208 = c__5548__auto___101204;
var G__101209 = cljs.core.count(c__5548__auto___101204);
var G__101210 = (0);
seq__100943_101191 = G__101207;
chunk__100944_101192 = G__101208;
count__100945_101193 = G__101209;
i__100946_101194 = G__101210;
continue;
} else {
var p_101211 = cljs.core.first(seq__100943_101203__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_101211) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__101213 = cljs.core.next(seq__100943_101203__$1);
var G__101214 = null;
var G__101215 = (0);
var G__101216 = (0);
seq__100943_101191 = G__101213;
chunk__100944_101192 = G__101214;
count__100945_101193 = G__101215;
i__100946_101194 = G__101216;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__5025__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__100938_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__100938_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__100966){
var vec__100967 = p__100966;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100967,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100967,(1),null);
var G__100970 = branch;
var G__100970__$1 = (((G__100970 instanceof cljs.core.Keyword))?G__100970.fqn:null);
switch (G__100970__$1) {
case "simple":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__100970__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__100979 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100979,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__100979,(1),null);
var G__100982 = branch;
var G__100982__$1 = (((G__100982 instanceof cljs.core.Keyword))?G__100982.fqn:null);
switch (G__100982__$1) {
case "simple":
return new cljs.core.Keyword(null,"kw","kw",1158308175).cljs$core$IFn$_invoke$arity$1(match);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__100982__$1)].join('')));
...
var len__5749__auto___101226 = arguments.length;
var i__5750__auto___101227 = (0);
while(true){
if((i__5750__auto___101227 < len__5749__auto___101226)){
args__5755__auto__.push((arguments[i__5750__auto___101227]));

var G__101228 = (i__5750__auto___101227 + (1));
i__5750__auto___101227 = G__101228;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq101017){
var G__101018 = cljs.core.first(seq101017);
var seq101017__$1 = cljs.core.next(seq101017);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__101018,seq101017__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__101052_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__101052_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__101053_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__101053_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__101058){
var vec__101059 = p__101058;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101059,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101059,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__101065_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__101065_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var G__101090 = arguments.length;
switch (G__101090) {
case 1:
...
var vec__101095 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
var seq__101096 = cljs.core.seq(vec__101095);
var first__101097 = cljs.core.first(seq__101096);
var seq__101096__$1 = cljs.core.next(seq__101096);
var line = first__101097;
var lines = seq__101096__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__101088_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__101088_SHARP_)].join('');
}),lines)));
}));
...
while(true){
var vec__101106 = in$;
var seq__101107 = cljs.core.seq(vec__101106);
var first__101108 = cljs.core.first(seq__101107);
var seq__101107__$1 = cljs.core.next(seq__101107);
var k = first__101108;
var rst = seq__101107__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__101109 = show_valid_values_QMARK_;
var G__101110 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__101111 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__101109,G__101110,G__101111) : expound.printer.summary_form.call(null,G__101109,G__101110,G__101111));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__101246 = show_valid_values_QMARK_;
var G__101247 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__101248 = rst__$1;
show_valid_values_QMARK_ = G__101246;
form = G__101247;
in$ = G__101248;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__101114 = show_valid_values_QMARK_;
var G__101115 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__101116 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__101114,G__101115,G__101116) : expound.printer.summary_form.call(null,G__101114,G__101115,G__101116));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__101117 = show_valid_values_QMARK_;
var G__101118 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__101119 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__101117,G__101118,G__101119) : expound.printer.summary_form.call(null,G__101117,G__101118,G__101119));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__101120 = show_valid_values_QMARK_;
var G__101121 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__101122 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__101120,G__101121,G__101122) : expound.printer.summary_form.call(null,G__101120,G__101121,G__101122));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__101123 = show_valid_values_QMARK_;
var G__101124 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__101125 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__101123,G__101124,G__101125) : expound.printer.summary_form.call(null,G__101123,G__101124,G__101125));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__101131_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__101131_SHARP_)).length);
...
var map__101134 = problem;
var map__101134__$1 = cljs.core.__destructure_map(map__101134);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101134__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__101134__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__101135 = opts;
var map__101135__$1 = cljs.core.__destructure_map(map__101135);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__101135__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__101139 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__101140 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__101140);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__101139);
}})();
var vec__101136 = cljs.core.re_find(regex,s);
var seq__101137 = cljs.core.seq(vec__101136);
var first__101138 = cljs.core.first(seq__101137);
var seq__101137__$1 = cljs.core.next(seq__101137);
var line = first__101138;
var first__101138__$1 = cljs.core.first(seq__101137__$1);
var seq__101137__$2 = cljs.core.next(seq__101137__$1);
var prefix = first__101138__$1;
var _more = seq__101137__$2;
