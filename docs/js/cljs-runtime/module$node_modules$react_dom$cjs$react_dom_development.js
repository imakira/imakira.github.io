      ...
      switch(workInProgress.tag) {
        ...
        case 3:
          ...
          if (current === null || current.child === null) {
            popHydrationState(workInProgress) ? workInProgress.flags |= 4 : current === null || current.memoizedState.isDehydrated && (workInProgress.flags & 256) === 0 || (workInProgress.flags |= 1024, hydrationErrors !== null && (queueRecoverableErrors(hydrationErrors), hydrationErrors = null));
          }
        ...
        case 5:
          ...
          if (current !== null && workInProgress.stateNode != null) {
            ...
            if (popHydrationState(workInProgress)) {
              ...
              currentHostContext = (workInProgress.mode & 1) !== 0;
              ...
              for (fiberRoot in props) {
                if (props.hasOwnProperty(fiberRoot)) {
                  if (_i = props[fiberRoot], fiberRoot === "children") {
                    typeof _i === "string" ? newProps.textContent !== _i && (props.suppressHydrationWarning !== !0 && checkForUnmatchedText(newProps.textContent, _i, currentHostContext, current), attributes = ["children", _i]) : typeof _i === "number" && newProps.textContent !== "" + _i && (props.suppressHydrationWarning !== !0 && checkForUnmatchedText(newProps.textContent, _i, currentHostContext, current), attributes = ["children", "" + _i]);
                  ...
                  } else if (current && typeof rootContainerInstance === "boolean") {
                    var serverValue, propertyInfo = getPropertyInfo(fiberRoot);
                    if (props.suppressHydrationWarning !== !0 && fiberRoot !== "suppressContentEditableWarning" && fiberRoot !== "suppressHydrationWarning" && fiberRoot !== "value" && fiberRoot !== "checked" && fiberRoot !== "selected") {
                        ...
                        if (propertyInfo !== null) {
                          b: {
                            if (extraAttributeNames.delete(propertyInfo.attributeName), styleValue = newProps, serverValue = fiberRoot, delimiter = _i, propertyInfo.mustUseProperty) {
                              ...
                              checkAttributeStringCoercion(delimiter, serverValue);
                          ...
                          serverValue = parentNamespace, serverValue === "http://www.w3.org/1999/xhtml" && (serverValue = getIntrinsicNamespace(renderLanes)), serverValue === "http://www.w3.org/1999/xhtml" ? extraAttributeNames.delete(fiberRoot.toLowerCase()) : (serverValue = fiberRoot.toLowerCase(), serverValue = possibleStandardNames.hasOwnProperty(serverValue) ? possibleStandardNames[serverValue] || null : null, serverValue !== null && serverValue !== fiberRoot && (serverHTML = !0, extraAttributeNames.delete(serverValue)), 
              ...
              current && extraAttributeNames.size > 0 && props.suppressHydrationWarning !== !0 && warnForExtraAttributes(extraAttributeNames);
              switch(renderLanes) {
                case "input":
                  track(newProps);
              ...
              current = rootContainerInstance.nodeType === 9 ? rootContainerInstance : rootContainerInstance.ownerDocument;
              fiberRoot = currentHostContext.namespace;
              fiberRoot === "http://www.w3.org/1999/xhtml" && (fiberRoot = getIntrinsicNamespace(renderLanes));
              fiberRoot === "http://www.w3.org/1999/xhtml" ? ((parentNamespace = isCustomComponent(renderLanes, newProps)) || renderLanes === renderLanes.toLowerCase() || error("\x3c%s /\x3e is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", renderLanes), renderLanes === "script" ? (current = current.createElement("div"), current.innerHTML = "\x3cscript\x3e\x3c/script\x3e", current = current.removeChild(current.firstChild)) : typeof newProps.is === "string" ? 
              current = current.createElement(renderLanes, {is:newProps.is}) : (current = current.createElement(renderLanes), renderLanes === "select" && (currentHostContext = current, newProps.multiple ? currentHostContext.multiple = !0 : newProps.size && (currentHostContext.size = newProps.size)))) : current = current.createElementNS(fiberRoot, renderLanes);
              fiberRoot !== "http://www.w3.org/1999/xhtml" || parentNamespace || Object.prototype.toString.call(current) !== "[object HTMLUnknownElement]" || hasOwnProperty.call(warnedUnknownTags, renderLanes) || (warnedUnknownTags[renderLanes] = !0, error("The tag \x3c%s\x3e is unrecognized in this browser. If you meant to render a React component, start its name with an uppercase letter.", renderLanes));
              fiberRoot = current;
              ...
              a: {
                ...
                for (props in currentHostContext) {
                  currentHostContext.hasOwnProperty(props) && (rootContainerInstance = currentHostContext[props], props === "style" ? (rootContainerInstance && Object.freeze(rootContainerInstance), setValueForStyles(fiberRoot, rootContainerInstance)) : props === "dangerouslySetInnerHTML" ? (rootContainerInstance = rootContainerInstance ? rootContainerInstance.__html : void 0, rootContainerInstance != null && setInnerHTML(fiberRoot, rootContainerInstance)) : props === "children" ? typeof rootContainerInstance === 
                  "string" ? (renderLanes !== "textarea" || rootContainerInstance !== "") && setTextContent(fiberRoot, rootContainerInstance) : typeof rootContainerInstance === "number" && setTextContent(fiberRoot, "" + rootContainerInstance) : props !== "suppressContentEditableWarning" && props !== "suppressHydrationWarning" && props !== "autoFocus" && (registrationNameDependencies.hasOwnProperty(props) ? rootContainerInstance != null && (typeof rootContainerInstance !== "function" && warnForInvalidEventListener(props, 
                  rootContainerInstance), props === "onScroll" && listenToNonDelegatedEvent("scroll", fiberRoot)) : rootContainerInstance != null && setValueForProperty(fiberRoot, props, rootContainerInstance, current)));
                }
                switch(renderLanes) {
                  case "input":
                    track(fiberRoot);
                  ...
                  case "textarea":
                    ...
                    break;
                  case "option":
                    newProps.value != null && fiberRoot.setAttribute("value", "" + getToStringValue(newProps.value));
                    break;
                  case "select":
                    ...
                    break;
                  default:
                    typeof parentNamespace.onClick === "function" && (fiberRoot.onclick = noop);
                }
                switch(renderLanes) {
                  case "button":
                  case "input":
            ...
            workInProgress.ref !== null && (workInProgress.flags |= 512, workInProgress.flags |= 2097152);
          }
          bubbleProperties(workInProgress);
          return null;
        case 6:
            ...
            if (popHydrationState(workInProgress)) {
              ...
              if (renderLanes = fiberRoot.nodeValue !== newProps) {
                if (props = hydrationParentFiber, props !== null) {
                  switch(props.tag) {
                    case 3:
                      checkForUnmatchedText(fiberRoot.nodeValue, newProps, (props.mode & 1) !== 0, !0);
                      break;
                    case 5:
                      props.memoizedProps.suppressHydrationWarning !== !0 && checkForUnmatchedText(fiberRoot.nodeValue, newProps, (props.mode & 1) !== 0, !0);
                  }
                }
              }
        ...
        case 13:
          ...
          if (current === null || current.memoizedState !== null && current.memoizedState.dehydrated !== null) {
            if (isHydrating && nextHydratableInstance !== null && (workInProgress.mode & 1) !== 0 && (workInProgress.flags & 128) === 0) {
              warnIfUnhydratedTailNodes(workInProgress), resetHydrationState(), workInProgress.flags |= 98560, newProps = !1;
            } else {
              if (newProps = popHydrationState(workInProgress), fiberRoot !== null && fiberRoot.dehydrated !== null) {
                if (current === null) {
                  if (!newProps) {
                    throw Error("A dehydrated suspense component was completed without a hydrated node. This is probably a bug in React.");
                  }
                  newProps = workInProgress.memoizedState;
                  newProps = newProps !== null ? newProps.dehydrated : null;
                  if (!newProps) {
                    throw Error("Expected to have a hydrated suspense instance. This error is likely caused by a bug in React. Please file an issue.");
                  }
                  newProps[internalInstanceKey] = workInProgress;
                  bubbleProperties(workInProgress);
                  (workInProgress.mode & 2) !== 0 && fiberRoot !== null && (newProps = workInProgress.child, newProps !== null && (workInProgress.treeBaseDuration -= newProps.treeBaseDuration));
                } else {
                  resetHydrationState(), (workInProgress.flags & 128) === 0 && (workInProgress.memoizedState = null), workInProgress.flags |= 4, bubbleProperties(workInProgress), (workInProgress.mode & 2) !== 0 && fiberRoot !== null && (newProps = workInProgress.child, newProps !== null && (workInProgress.treeBaseDuration -= newProps.treeBaseDuration));
                }
                newProps = !1;
              } else {
                hydrationErrors !== null && (queueRecoverableErrors(hydrationErrors), hydrationErrors = null), newProps = !0;
              }
            }
            if (!newProps) {
          ...
          if ((workInProgress.flags & 128) !== 0) {
            return workInProgress.lanes = renderLanes, (workInProgress.mode & 2) !== 0 && transferActualDuration(workInProgress), workInProgress;
          }
          fiberRoot = fiberRoot !== null;
          fiberRoot !== (current !== null && current.memoizedState !== null) && fiberRoot && (workInProgress.child.flags |= 8192, (workInProgress.mode & 1) !== 0 && (current === null || (suspenseStackCursor.current & 1) !== 0 ? workInProgressRootExitStatus === RootInProgress && (workInProgressRootExitStatus = RootSuspended) : renderDidSuspendDelayIfPossible()));
          workInProgress.updateQueue !== null && (workInProgress.flags |= 4);
          bubbleProperties(workInProgress);
          (workInProgress.mode & 2) !== 0 && fiberRoot && (fiberRoot = workInProgress.child, fiberRoot !== null && (workInProgress.treeBaseDuration -= fiberRoot.treeBaseDuration));
          return null;
        case 4:
          return popHostContainer(workInProgress), updateHostContainer(current, workInProgress), current === null && listenToAllSupportedEvents(workInProgress.stateNode.containerInfo), bubbleProperties(workInProgress), null;
        case 10:
        ...
        case 19:
          ...
          fiberRoot = (workInProgress.flags & 128) !== 0;
          ...
          if (props === null) {
            if (fiberRoot) {
              ...
              if (workInProgressRootExitStatus !== RootInProgress || current !== null && (current.flags & 128) !== 0) {
                for (props = workInProgress.child; props !== null;) {
                  ...
                  if (current !== null) {
                    ...
                    fiberRoot !== null && (workInProgress.updateQueue = fiberRoot, workInProgress.flags |= 4);
                    workInProgress.subtreeFlags = 0;
                    fiberRoot = renderLanes;
                    for (newProps = workInProgress.child; newProps !== null;) {
                      renderLanes = newProps, current = fiberRoot, renderLanes.flags &= 14680066, props = renderLanes.alternate, props === null ? (renderLanes.childLanes = 0, renderLanes.lanes = current, renderLanes.child = null, renderLanes.subtreeFlags = 0, renderLanes.memoizedProps = null, renderLanes.memoizedState = null, renderLanes.updateQueue = null, renderLanes.dependencies = null, renderLanes.stateNode = null, renderLanes.selfBaseDuration = 0, renderLanes.treeBaseDuration = 0) : (renderLanes.childLanes = 
                      props.childLanes, renderLanes.lanes = props.lanes, renderLanes.child = props.child, renderLanes.subtreeFlags = 0, renderLanes.deletions = null, renderLanes.memoizedProps = props.memoizedProps, renderLanes.memoizedState = props.memoizedState, renderLanes.updateQueue = props.updateQueue, renderLanes.type = props.type, current = props.dependencies, renderLanes.dependencies = current === null ? null : {lanes:current.lanes, firstContext:current.firstContext}, renderLanes.selfBaseDuration = 
              ...
              newProps.tail !== null && now() > workInProgressRootRenderTargetTime && (workInProgress.flags |= 128, fiberRoot = !0, cutOffTailIfNeeded(newProps, !1), workInProgress.lanes = 4194304);
            }
          } else {
            if (!fiberRoot) {
              if (current = findFirstSuspended(props), current !== null) {
                if (workInProgress.flags |= 128, fiberRoot = !0, renderLanes = current.updateQueue, renderLanes !== null && (workInProgress.updateQueue = renderLanes, workInProgress.flags |= 4), cutOffTailIfNeeded(newProps, !0), newProps.tail === null && newProps.tailMode === "hidden" && !props.alternate && !isHydrating) {
                  return bubbleProperties(workInProgress), null;
                }
              } else {
                now() * 2 - newProps.renderingStartTime > workInProgressRootRenderTargetTime && renderLanes !== OffscreenLane && (workInProgress.flags |= 128, fiberRoot = !0, cutOffTailIfNeeded(newProps, !1), workInProgress.lanes = 4194304);
              }
            }
            newProps.isBackwards ? (props.sibling = workInProgress.child, workInProgress.child = props) : (renderLanes = newProps.last, renderLanes !== null ? renderLanes.sibling = props : workInProgress.child = props, newProps.last = props);
          }
        ...
        case 22:
        case 23:
          return popRenderLanes(workInProgress), fiberRoot = workInProgress.memoizedState !== null, current !== null && current.memoizedState !== null !== fiberRoot && (workInProgress.flags |= 8192), fiberRoot && (workInProgress.mode & 1) !== 0 ? (subtreeRenderLanes & OffscreenLane) !== 0 && (bubbleProperties(workInProgress), workInProgress.subtreeFlags & 6 && (workInProgress.flags |= 8192)) : bubbleProperties(workInProgress), null;
        case 24:
          return null;
        case 25:
          return null;
