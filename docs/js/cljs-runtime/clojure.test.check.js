...
var vec__103563 = temp__5821__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103563,(0),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103563,(1),null);
...
var len__5749__auto___103703 = arguments.length;
var i__5750__auto___103704 = (0);
while(true){
if((i__5750__auto___103704 < len__5749__auto___103703)){
args__5755__auto__.push((arguments[i__5750__auto___103704]));

var G__103705 = (i__5750__auto___103704 + (1));
i__5750__auto___103704 = G__103705;
continue;
} else {
}
break;
...
(clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__103591){
var map__103592 = p__103591;
var map__103592__$1 = cljs.core.__destructure_map(map__103592);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103592__$1,new cljs.core.Keyword(null,"seed","seed",68613327));
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__103592__$1,new cljs.core.Keyword(null,"max-size","max-size",-874966132),(200));
var reporter_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__103592__$1,new cljs.core.Keyword(null,"reporter-fn","reporter-fn",1280520247),cljs.core.constantly(null));
var vec__103596 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103596,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103596,(1),null);
...
var vec__103623 = size_seq__$1;
var seq__103624 = cljs.core.seq(vec__103623);
var first__103625 = cljs.core.first(seq__103624);
var seq__103624__$1 = cljs.core.next(seq__103624);
var size = first__103625;
var rest_size_seq = seq__103624__$1;
var vec__103626 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103626,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__103626,(1),null);
...
/** @this {Function} */
(clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq103583){
var G__103585 = cljs.core.first(seq103583);
var seq103583__$1 = cljs.core.next(seq103583);
var G__103586 = cljs.core.first(seq103583__$1);
var seq103583__$2 = cljs.core.next(seq103583__$1);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__103585,G__103586,seq103583__$2);
}));
...
var map__103637 = smallest;
var map__103637__$1 = cljs.core.__destructure_map(map__103637);
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__103637__$1,new cljs.core.Keyword(null,"result","result",1415092211));
...
var G__103723 = tail;
var G__103724 = current_smallest;
var G__103725 = (total_nodes_visited + (1));
var G__103726 = depth;
nodes = G__103723;
current_smallest = G__103724;
total_nodes_visited = G__103725;
depth = G__103726;
continue;
} else {
var new_smallest = clojure.test.check.rose_tree.root(head);
var G__103668_103727 = cljs.core.assoc_in(reporter_fn_arg,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"shrinking","shrinking",2049648186),new cljs.core.Keyword(null,"smallest","smallest",-152623883)], null),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(new_smallest));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__103668_103727) : reporter_fn.call(null,G__103668_103727));
...
var G__103731 = children;
var G__103732 = new_smallest;
var G__103733 = (total_nodes_visited + (1));
var G__103734 = (depth + (1));
nodes = G__103731;
current_smallest = G__103732;
total_nodes_visited = G__103733;
depth = G__103734;
continue;
} else {
var G__103735 = tail;
var G__103736 = new_smallest;
var G__103737 = (total_nodes_visited + (1));
var G__103738 = depth;
nodes = G__103735;
current_smallest = G__103736;
total_nodes_visited = G__103737;
depth = G__103738;
continue;
}
}
...
var G__103678_103742 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"failure","failure",720415879));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__103678_103742) : reporter_fn.call(null,G__103678_103742));

var shrunk = clojure.test.check.shrink_loop(failing_rose_tree,(function (p1__103671_SHARP_){
var G__103680 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([failure_data,p1__103671_SHARP_], 0));
return (reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__103680) : reporter_fn.call(null,G__103680));
}));
var G__103683_103743 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(failure_data,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"shrunk","shrunk",-2041664412),shrunk], 0));
(reporter_fn.cljs$core$IFn$_invoke$arity$1 ? reporter_fn.cljs$core$IFn$_invoke$arity$1(G__103683_103743) : reporter_fn.call(null,G__103683_103743));
