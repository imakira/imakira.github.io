shadow$provide.module$node_modules$react_dom$cjs$react_dom_server_browser_production_min = function(global, require, module, exports) {
  function k(a) {
  ...
  function za(a, b, c, d, f) {
    a = void 0 === a ? "" : a;
    b = void 0 === b ? sa : w('\x3cscript nonce\x3d"' + C(b) + '"\x3e');
    var e = [];
  ...
  function Jc(a, b, c) {
    ...
    if (a === R) {
      if (Cc = !0, a = {action:c, next:null}, null === V && (V = new Map()), c = V.get(b), void 0 === c) {
        V.set(b, a);
      } else {
        for (b = c; null !== b.next;) {
          b = b.next;
  ...
  var aa = require("module$node_modules$react$index"), l = null, n = 0, ca = new TextEncoder(), x = Object.prototype.hasOwnProperty, ea = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, fa = {}, ha = 
  {}, z = {};
  ...
  tabSize:!0, widows:!0, zIndex:!0, zoom:!0, fillOpacity:!0, floodOpacity:!0, stopOpacity:!0, strokeDasharray:!0, strokeDashoffset:!0, strokeMiterlimit:!0, strokeOpacity:!0, strokeWidth:!0}, la = ["Webkit", "ms", "Moz", "O"];
  ...
  var oa = /["'&<>]/, pa = /([A-Z])/g, qa = /^ms-/, ra = Array.isArray, sa = w("\x3cscript\x3e"), ta = w("\x3c/script\x3e"), ua = w('\x3cscript src\x3d"'), va = w('\x3cscript type\x3d"module" src\x3d"'), wa = w('" async\x3d""\x3e\x3c/script\x3e'), xa = /(<\/|<)(s)(cript)/gi, Ca = w("\x3c!-- --\x3e"), Ea = new Map(), Fa = w(' style\x3d"'), Ga = w(":"), Ha = w(";"), H = w(" "), I = w('\x3d"'), E = w('"'), Ja = w('\x3d""'), K = w("\x3e"), Ka = w("/\x3e"), Ma = w(' selected\x3d""'), Oa = w("\n"), Pa = 
  /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/, Qa = new Map(), Ra = w("\x3c!DOCTYPE html\x3e"), Ta = w("\x3c/"), Ua = w("\x3e"), Va = w('\x3ctemplate id\x3d"'), Wa = w('"\x3e\x3c/template\x3e'), Xa = w("\x3c!--$--\x3e"), Ya = w('\x3c!--$?--\x3e\x3ctemplate id\x3d"'), Za = w('"\x3e\x3c/template\x3e'), $a = w("\x3c!--$!--\x3e"), ab = w("\x3c!--/$--\x3e"), bb = w("\x3ctemplate"), cb = w('"'), db = w(' data-dgst\x3d"');
  w(' data-msg\x3d"');
  w(' data-stck\x3d"');
  var eb = w("\x3e\x3c/template\x3e"), gb = w('\x3cdiv hidden id\x3d"'), hb = w('"\x3e'), ib = w("\x3c/div\x3e"), jb = w('\x3csvg aria-hidden\x3d"true" style\x3d"display:none" id\x3d"'), kb = w('"\x3e'), lb = w("\x3c/svg\x3e"), mb = w('\x3cmath aria-hidden\x3d"true" style\x3d"display:none" id\x3d"'), nb = w('"\x3e'), ob = w("\x3c/math\x3e"), pb = w('\x3ctable hidden id\x3d"'), qb = w('"\x3e'), rb = w("\x3c/table\x3e"), sb = w('\x3ctable hidden\x3e\x3ctbody id\x3d"'), tb = w('"\x3e'), ub = w("\x3c/tbody\x3e\x3c/table\x3e"), 
  vb = w('\x3ctable hidden\x3e\x3ctr id\x3d"'), wb = w('"\x3e'), xb = w("\x3c/tr\x3e\x3c/table\x3e"), yb = w('\x3ctable hidden\x3e\x3ccolgroup id\x3d"'), zb = w('"\x3e'), Ab = w("\x3c/colgroup\x3e\x3c/table\x3e"), Db = w('function $RS(a,b){a\x3ddocument.getElementById(a);b\x3ddocument.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)};$RS("'), Eb = w('$RS("'), Gb = w('","'), Hb = w('")\x3c/script\x3e'), Ib = w('function $RC(a,b){a\x3ddocument.getElementById(a);b\x3ddocument.getElementById(b);b.parentNode.removeChild(b);if(a){a\x3da.previousSibling;var f\x3da.parentNode,c\x3da.nextSibling,e\x3d0;do{if(c\x26\x268\x3d\x3d\x3dc.nodeType){var d\x3dc.data;if("/$"\x3d\x3d\x3dd)if(0\x3d\x3d\x3de)break;else e--;else"$"!\x3d\x3dd\x26\x26"$?"!\x3d\x3dd\x26\x26"$!"!\x3d\x3dd||e++}d\x3dc.nextSibling;f.removeChild(c);c\x3dd}while(c);for(;b.firstChild;)f.insertBefore(b.firstChild,c);a.data\x3d"$";a._reactRetry\x26\x26a._reactRetry()}};$RC("'), 
  Jb = w('$RC("'), Kb = w('","'), Lb = w('")\x3c/script\x3e'), Mb = w('function $RX(b,c,d,e){var a\x3ddocument.getElementById(b);a\x26\x26(b\x3da.previousSibling,b.data\x3d"$!",a\x3da.dataset,c\x26\x26(a.dgst\x3dc),d\x26\x26(a.msg\x3dd),e\x26\x26(a.stck\x3de),b._reactRetry\x26\x26b._reactRetry())};$RX("'), Nb = w('$RX("'), Ob = w('"'), Pb = w(")\x3c/script\x3e"), Qb = w(","), Rb = /[<\u2028\u2029]/g, N = Object.assign, Tb = Symbol.for("react.element"), Ub = Symbol.for("react.portal"), Vb = Symbol.for("react.fragment"), 
  Wb = Symbol.for("react.strict_mode"), Xb = Symbol.for("react.profiler"), Yb = Symbol.for("react.provider"), Zb = Symbol.for("react.context"), $b = Symbol.for("react.forward_ref"), ac = Symbol.for("react.suspense"), bc = Symbol.for("react.suspense_list"), cc = Symbol.for("react.memo"), dc = Symbol.for("react.lazy"), ec = Symbol.for("react.scope"), fc = Symbol.for("react.debug_trace_mode"), gc = Symbol.for("react.legacy_hidden"), hc = Symbol.for("react.default_value"), ic = Symbol.iterator, kc = 
  {}, O = null, qc = {isMounted:function() {
    return !1;
  ...
  }}, sc = {id:1, overflow:""}, uc = Math.clz32 ? Math.clz32 : vc, wc = Math.log, xc = Math.LN2, zc = "function" === typeof Object.is ? Object.is : yc, R = null, Ac = null, Bc = null, S = null, T = !1, Cc = !1, U = 0, V = null, Dc = 0, Oc = {readContext:function(a) {
