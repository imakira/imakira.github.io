...
return cljs.core.cons(cljs.core.first(s),(function (){var G__101901 = (n - (1));
var G__101902 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__101901,G__101902) : clojure.test.check.rose_tree.exclude_nth.call(null,G__101901,G__101902));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__101914 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__101914) : f.call(null,G__101914));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__101912_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__101912_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__101912_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__101923_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__101923_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__101923_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__101924_SHARP_){
var G__101926 = clojure.test.check.rose_tree.root(p1__101924_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__101926) : pred.call(null,G__101926));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__5503__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__101935(s__101936){
return (new cljs.core.LazySeq(null,(function (){
var s__101936__$1 = s__101936;
while(true){
var temp__5823__auto__ = cljs.core.seq(s__101936__$1);
if(temp__5823__auto__){
var xs__6383__auto__ = temp__5823__auto__;
var vec__101942 = cljs.core.first(xs__6383__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101942,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__101942,(1),null);
var iterys__5499__auto__ = ((function (s__101936__$1,vec__101942,rose,index,xs__6383__auto__,temp__5823__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__101935_$_iter__101937(s__101938){
return (new cljs.core.LazySeq(null,((function (s__101936__$1,vec__101942,rose,index,xs__6383__auto__,temp__5823__auto__){
return (function (){
var s__101938__$1 = s__101938;
while(true){
var temp__5823__auto____$1 = cljs.core.seq(s__101938__$1);
if(temp__5823__auto____$1){
var s__101938__$2 = temp__5823__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__101938__$2)){
var c__5501__auto__ = cljs.core.chunk_first(s__101938__$2);
var size__5502__auto__ = cljs.core.count(c__5501__auto__);
var b__101940 = cljs.core.chunk_buffer(size__5502__auto__);
if((function (){var i__101939 = (0);
while(true){
if((i__101939 < size__5502__auto__)){
var child = cljs.core._nth(c__5501__auto__,i__101939);
cljs.core.chunk_append(b__101940,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__102140 = (i__101939 + (1));
i__101939 = G__102140;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__101940),clojure$test$check$rose_tree$permutations_$_iter__101935_$_iter__101937(cljs.core.chunk_rest(s__101938__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__101940),null);
}
} else {
var child = cljs.core.first(s__101938__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__101935_$_iter__101937(cljs.core.rest(s__101938__$2)));
}
} else {
return null;
}
...
});})(s__101936__$1,vec__101942,rose,index,xs__6383__auto__,temp__5823__auto__))
,null,null));
});})(s__101936__$1,vec__101942,rose,index,xs__6383__auto__,temp__5823__auto__))
;
var fs__5500__auto__ = cljs.core.seq(iterys__5499__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__5500__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5500__auto__,clojure$test$check$rose_tree$permutations_$_iter__101935(cljs.core.rest(s__101936__$1)));
} else {
var G__102155 = cljs.core.rest(s__101936__$1);
s__101936__$1 = G__102155;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__101959_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__101959_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__101959_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__101971_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__101971_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__101971_SHARP_));
...
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons((function (){var G__101995 = f;
var G__101996 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__101995,G__101996) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__101995,G__101996));
})(),(new cljs.core.LazySeq(null,(function (){
return (new cljs.core.List(null,(function (){var G__102004 = f;
var G__102005 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__102004,G__102005) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__102004,G__102005));
})(),null,(1),null));
}),null,null)));
}),null,null));
} else {
