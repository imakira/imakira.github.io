...
var G__76828__i = 0, G__76828__a = new Array(arguments.length -  0);
while (G__76828__i < G__76828__a.length) {G__76828__a[G__76828__i] = arguments[G__76828__i + 0]; ++G__76828__i;}
  args = new cljs.core.IndexedSeq(G__76828__a,0,null);
} 
return G__76826__delegate.call(this,args);};
G__76826.cljs$lang$maxFixedArity = 0;
G__76826.cljs$lang$applyTo = (function (arglist__76829){
var args = cljs.core.seq(arglist__76829);
 ...
 */
uix.core.create_class = (function uix$core$create_class(p__76208){
var map__76209 = p__76208;
var map__76209__$1 = cljs.core.__destructure_map(map__76209);
var fields = map__76209__$1;
var contextType = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"contextType","contextType",1033066077));
var componentDidUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"componentDidUpdate","componentDidUpdate",-1983477981));
var componentDidCatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"componentDidCatch","componentDidCatch",821717733));
var displayName = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"displayName","displayName",-809144601));
var childContextTypes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"childContextTypes","childContextTypes",578717991));
var getSnapshotBeforeUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"getSnapshotBeforeUpdate","getSnapshotBeforeUpdate",861122184));
var contextTypes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"contextTypes","contextTypes",-2023853910));
var getDerivedStateFromProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"getDerivedStateFromProps","getDerivedStateFromProps",-991834739));
var getDerivedStateFromError = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"getDerivedStateFromError","getDerivedStateFromError",166658477));
var componentWillUnmount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"componentWillUnmount","componentWillUnmount",1573788814));
var shouldComponentUpdate = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"shouldComponentUpdate","shouldComponentUpdate",1795750960));
var render = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"render","render",-1408033454));
var defaultProps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"defaultProps","defaultProps",-533483149));
var getInitialState = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"getInitialState","getInitialState",1541760916));
var constructor$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"constructor","constructor",-1953928811));
var componentDidMount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76209__$1,new cljs.core.Keyword(null,"componentDidMount","componentDidMount",955710936));
...
var G__76271 = props.argv;
if(cljs.core.truth_(props.children)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76271,new cljs.core.Keyword(null,"children","children",-940561982),props.children);
} else {
return G__76271;
}
});
...
if((ref.current == null)){
(ref.current = (function (){var x76319 = ({"current": value});
(x76319.cljs$core$IDeref$ = cljs.core.PROTOCOL_SENTINEL);

(x76319.cljs$core$IDeref$_deref$arity$1 = (function (this$){
var this$__$1 = this;
return this$__$1.current;
}));

(x76319.cljs$core$IReset$ = cljs.core.PROTOCOL_SENTINEL);

(x76319.cljs$core$IReset$_reset_BANG_$arity$2 = (function (this$,v){
var this$__$1 = this;
return (this$__$1.current = v);
}));

(x76319.cljs$core$ISwap$ = cljs.core.PROTOCOL_SENTINEL);

(x76319.cljs$core$ISwap$_swap_BANG_$arity$2 = (function (this$,f){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__76322 = this$__$1.current;
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__76322) : f.call(null,G__76322));
})());
}));

(x76319.cljs$core$ISwap$_swap_BANG_$arity$3 = (function (this$,f,a){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__76327 = this$__$1.current;
var G__76328 = a;
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__76327,G__76328) : f.call(null,G__76327,G__76328));
})());
}));

(x76319.cljs$core$ISwap$_swap_BANG_$arity$4 = (function (this$,f,a,b){
var this$__$1 = this;
return (this$__$1.current = (function (){var G__76329 = this$__$1.current;
var G__76330 = a;
var G__76331 = b;
return (f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__76329,G__76330,G__76331) : f.call(null,G__76329,G__76330,G__76331));
})());
}));

(x76319.cljs$core$ISwap$_swap_BANG_$arity$5 = (function (this$,f,a,b,xs){
var this$__$1 = this;
...
var G__76913__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(ref),args);
};
var G__76913 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__76914__i = 0, G__76914__a = new Array(arguments.length -  0);
while (G__76914__i < G__76914__a.length) {G__76914__a[G__76914__i] = arguments[G__76914__i + 0]; ++G__76914__i;}
  args = new cljs.core.IndexedSeq(G__76914__a,0,null);
} 
return G__76913__delegate.call(this,args);};
G__76913.cljs$lang$maxFixedArity = 0;
G__76913.cljs$lang$applyTo = (function (arglist__76921){
var args = cljs.core.seq(arglist__76921);
return G__76913__delegate(args);
});
G__76913.cljs$core$IFn$_invoke$arity$variadic = G__76913__delegate;
return G__76913;
})()
...
return (function (p1__76504_SHARP_){
var G__76506 = cljs_bean.core.bean.cljs$core$IFn$_invoke$arity$1(p1__76504_SHARP_);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__76506) : f.call(null,G__76506));
});
});
/**
 ...
 */
uix.core.create_error_boundary = (function uix$core$create_error_boundary(p__76588,render_fn){
var map__76589 = p__76588;
var map__76589__$1 = cljs.core.__destructure_map(map__76589);
var display_name = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__76589__$1,new cljs.core.Keyword(null,"display-name","display-name",694513143),(""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1("uix.error-boundary"))));
var derive_error_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76589__$1,new cljs.core.Keyword(null,"derive-error-state","derive-error-state",-1373095498));
var did_catch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76589__$1,new cljs.core.Keyword(null,"did-catch","did-catch",2139522313));
var constructor$ = (function (this$,_){
var setState = this$.setState.bind(this$);
var set_state = (function (new_value){
var G__76597 = ({"argv": new_value});
return (setState.cljs$core$IFn$_invoke$arity$1 ? setState.cljs$core$IFn$_invoke$arity$1(G__76597) : setState.call(null,G__76597));
});
...
var G__76624 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [state.argv,this$.setState], null);
var G__76625 = uix.core.glue_args(props);
return (render_fn.cljs$core$IFn$_invoke$arity$2 ? render_fn.cljs$core$IFn$_invoke$arity$2(G__76624,G__76625) : render_fn.call(null,G__76624,G__76625));
});
...
var argv = (function (){var G__76646 = props.argv;
var G__76646__$1 = (cljs.core.truth_(props.children)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76646,new cljs.core.Keyword(null,"children","children",-940561982),props.children):G__76646);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76646__$1,new cljs.core.Keyword(null,"ref","ref",1289896967),ref);
...
var len__5875__auto___76976 = arguments.length;
var i__5876__auto___76977 = (0);
while(true){
if((i__5876__auto___76977 < len__5875__auto___76976)){
args__5881__auto__.push((arguments[i__5876__auto___76977]));

var G__76978 = (i__5876__auto___76977 + (1));
i__5876__auto___76977 = G__76978;
continue;
} else {
}
break;
...
return uix.core.clone_element.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5882__auto__);
});
...
var update_children = (function (p1__76671_SHARP_){
if(cljs.core.truth_(p1__76671_SHARP_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (el){
if(cljs.core.truth_((function (){var G__76703 = el;
if((G__76703 == null)){
return null;
} else {
return G__76703._store;
}
})())){
...
var nel = uix.compiler.alpha.component_element(type,uix.compiler.attributes.interpret_props((function (){var G__76724 = props__$1;
if(cljs.core.seq(children__$1)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76724,new cljs.core.Keyword(null,"children","children",-940561982),cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(children__$1));
} else {
return G__76724;
}
})()),[]);
...
return uix.compiler.alpha.component_element(type,uix.compiler.attributes.interpret_props((function (){var G__76732 = oprops;
var G__76732__$1 = (cljs.core.truth_(okey)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76732,new cljs.core.Keyword(null,"key","key",-1516042587),okey):G__76732);
var G__76732__$2 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([G__76732__$1,props__$1], 0))
;
if(cljs.core.seq(children__$1)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76732__$2,new cljs.core.Keyword(null,"children","children",-940561982),children__$1);
} else {
return G__76732__$2;
}
})()),[]);
...
/** @this {Function} */
(uix.core.clone_element.cljs$lang$applyTo = (function (seq76682){
var G__76683 = cljs.core.first(seq76682);
var seq76682__$1 = cljs.core.next(seq76682);
var G__76690 = cljs.core.first(seq76682__$1);
var seq76682__$2 = cljs.core.next(seq76682__$1);
var self__5860__auto__ = this;
return self__5860__auto__.cljs$core$IFn$_invoke$arity$variadic(G__76683,G__76690,seq76682__$2);
}));
...
})], null),(function (p__76766,p__76767){
var vec__76768 = p__76766;
var map__76771 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76768,(0),null);
var map__76771__$1 = cljs.core.__destructure_map(map__76771);
var state = map__76771__$1;
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76771__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76771__$1,new cljs.core.Keyword(null,"info","info",-317069002));
var loc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76771__$1,new cljs.core.Keyword(null,"loc","loc",-584284901));
var set_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76768,(1),null);
var map__76772 = p__76767;
var map__76772__$1 = cljs.core.__destructure_map(map__76772);
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76772__$1,new cljs.core.Keyword(null,"children","children",-940561982));
