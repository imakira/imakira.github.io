...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_96798 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_96798(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_96819 = (function (runtime,key,spec){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_96819(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_96826 = (function (runtime,key){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_96826(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_96828 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_96828(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_96843 = (function (runtime,input,callback){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_96843(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_96852 = (function (runtime,code,success,fail){
var x__5373__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_96852(runtime,code,success,fail);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__96774,callback){
var map__96776 = p__96774;
var map__96776__$1 = cljs.core.__destructure_map(map__96776);
var input = map__96776__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96776__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__96776__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
