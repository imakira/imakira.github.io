...
var G__99824 = cljs.core.next(xs);
var G__99825 = cljs.core.next(ys);
xs = G__99824;
ys = G__99825;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__99794 = val;
var G__99795 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__99794,G__99795) : f.call(null,G__99794,G__99795));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__99798 = val__$1;
var G__99799 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__99798,G__99799) : f.call(null,G__99798,G__99799));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__99800 = val__$1;
var G__99801 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__99800,G__99801) : f.call(null,G__99800,G__99801));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__99837 = cljs.core.next(es);
var G__99838 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__99837;
tcoll__$1 = G__99838;
continue;
} else {
...
var G__99839 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__99840 = cljs.core.next(es);
ret = G__99839;
es = G__99840;
continue;
} else {
