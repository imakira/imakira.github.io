...
var G__71288 = cljs.core.next(xs);
var G__71289 = cljs.core.next(ys);
xs = G__71288;
ys = G__71289;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__71202 = val;
var G__71203 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__71202,G__71203) : f.call(null,G__71202,G__71203));
})();
...
while(true){
if((n < cnt)){
var nval = (function (){var G__71209 = val__$1;
var G__71210 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__71209,G__71210) : f.call(null,G__71209,G__71210));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__71212 = val__$1;
var G__71213 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__71212,G__71213) : f.call(null,G__71212,G__71213));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__71313 = cljs.core.next(es);
var G__71314 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__71313;
tcoll__$1 = G__71314;
continue;
} else {
...
var G__71317 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__71318 = cljs.core.next(es);
ret = G__71317;
es = G__71318;
continue;
} else {
