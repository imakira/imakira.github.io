...
var G__75596 = cljs.core.next(xs);
var G__75597 = cljs.core.next(ys);
xs = G__75596;
ys = G__75597;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__75522 = val;
var G__75523 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
...
while(true){
if((n < cnt)){
var nval = (function (){var G__75524 = val__$1;
var G__75525 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__75524,G__75525) : f.call(null,G__75524,G__75525));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__75532 = val__$1;
var G__75533 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__75532,G__75533) : f.call(null,G__75532,G__75533));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__75606 = cljs.core.next(es);
var G__75607 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__75606;
tcoll__$1 = G__75607;
continue;
} else {
...
var G__75611 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__75612 = cljs.core.next(es);
ret = G__75611;
es = G__75612;
continue;
} else {
